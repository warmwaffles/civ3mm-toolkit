...
BOOL MFCAIDS_API uReadFile(LPCTSTR lpszFileName,
                           CString& sContent,
                           UINT nOpenFlags = CFile::modeRead | CFile::shareDenyNone); // Reads file in text mode and returns file content
BOOL MFCAIDS_API uWriteFile(LPCTSTR lpszTxt,
                            CString sContent,
                            UINT nOpenFlags = CFile::modeCreate | CFile::modeReadWrite); // Write file content to the file
