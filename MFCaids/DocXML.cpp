...
CDocXML::CDocXML()
{
    ...
    CHECK_COM_RESULT(CoCreateInstance(MSXML::CLSID_DOMDocument, NULL, CLSCTX_INPROC_SERVER, MSXML::IID_IXMLDOMDocument, (void**)&m_pDoc));
...
HRESULT
CDocXMLException::GetHResultCode()
{
    return m_hResult;
}

BOOL
CDocXML::Load(LPCTSTR fileName)
{
    VARIANT_BOOL vb;
...
BOOL
CDocXML::SaveXmlDoc(LPCTSTR fileName)
{
    AFX_MANAGE_STATE(AfxGetStaticModuleState());
    HRESULT hr;
...
CString
CDocXMLException::GetErrorDescription()
{
    CString errDesc;
...
void
CDocXML::CreateDocHeader(LPCTSTR encoding)
{
    _bstr_t data;
...
void
CDocXML::CreateElement(LPCTSTR name)
{
...
void
CDocXML::CreateTextNode(LPCTSTR name)
{
...
void
CDocXML::CreateAttribute(LPCTSTR name, LPCTSTR value)
{
    MSXML::IXMLDOMElement* pElement;
...
BOOL
CDocXML::ChangeNode(LPCTSTR name)
{
...
BOOL
CDocXML::ChangeNode(LPCTSTR name, INT id)
{
    VARIANT_BOOL bHasChild;
...
CString
CDocXML::GetAttribute(LPCTSTR att)
{
...
BOOL
CDocXML::SetFirstNode(POSITION& pos, LPCSTR pNodeName)
{
    long nItem   = 0;
    BOOL bResult = FALSE;
...
BOOL
CDocXML::SetNode(POSITION posProc, int i)
{
    long nItem   = 0;
    BOOL bResult = FALSE;
...
void
CDocXML::CloseNodes(POSITION posNodeList)
{
...
void
CDocXML::LoadXML(_bstr_t sXMLDoc)
{
    VARIANT_BOOL vb;
