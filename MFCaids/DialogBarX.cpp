...
void
CDialogBarX::OnUpdateCmdUI(class CFrameWnd* pTarget, int bDisableIfNoHndler)
{
    UpdateDialogControls(pTarget, bDisableIfNoHndler);
}

BOOL
CDialogBarX::Create(CWnd* pParentWnd, CDialog* pDialog, CString& pTitle, UINT nID, DWORD dwStyle)
{
...
CSize
CDialogBarX::CalcFixedLayout(BOOL bStretch, BOOL bHorz)
{
    CRect rc;
...
CSize
CDialogBarX::CalcDynamicLayout(int nLength, DWORD dwMode)
{
...
void
CDialogBarX::OnWindowPosChanged(WINDOWPOS FAR* lpwndpos)
{
...
BOOL
CDialogBarX::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message)
{
...
//
void
CDialogBarX::OnLButtonUp(UINT nFlags, CPoint point)
{
    if (m_bPressedClose) {
        ReleaseCapture();
...
void
CDialogBarX::OnMouseMove(UINT nFlags, CPoint point)
{
    if (m_bPressedClose) {
        CRect rc;
        GetWindowRect(rc);
...
void
CDialogBarX::OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS FAR* lpncsp)
{
...
void
CDialogBarX::OnNcLButtonDown(UINT nHitTest, CPoint point)
{
    if (m_bTracking)
        return;
...
void
CDialogBarX::OnNcLButtonUp(UINT nHitTest, CPoint point)
{
    if (m_bTracking)
        return;
...
UINT
CDialogBarX::OnNcHitTest(CPoint point)
{
    if (IsFloating())
...
void
CDialogBarX::OnLButtonDown(UINT nFlags, CPoint point)
{
...
void
CDialogBarX::OnLButtonDblClk(UINT nFlags, CPoint point)
{
...
void
CDialogBarX::OnCaptureChanged(CWnd* pWnd)
{
...
void
CDialogBarX::StopTracking(BOOL bAccept)
{
    OnInvertTracker(m_rectTracker);
...
void
CDialogBarX::OnInvertTracker(const CRect& rect)
{
    ASSERT_VALID(this);
...
void
CDialogBarX::DrawGripper(CDC* pDC)
{
...
void
CDialogBarX::OnNcLButtonDblClk(UINT nHitTest, CPoint point)
{
...
void
CDialogBarX::ToggleDocking()
{
    m_pDockContext->ToggleDocking();
}

void
CDialogBarX::EnableDocking(DWORD dwStyle)
{
...
void
CDialogBarX::OnSize(UINT nType, int cx, int cy)
{
