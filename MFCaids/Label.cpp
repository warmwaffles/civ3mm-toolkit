...
CLabel& CLabel::SetText(const CString& sText)
{
	SetWindowText(sText);
	return *this;
}
...
CLabel& CLabel::SetFontName(const CString& sFont)
{	
...
void CLabelTitle::SetName(CString sName)
{
