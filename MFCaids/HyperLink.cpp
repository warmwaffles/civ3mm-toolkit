...
void CHyperLink::ReportError(int nError)
{
	...
	switch ( nError ) 
	{
		case 0:                       id = IDS_ERR_OS_OUT_OF_RES;			break;
		case SE_ERR_PNF:              id = IDS_ERR_PATH_NOT_FOUND;			break;
		case SE_ERR_FNF:              id = IDS_ERR_FILE_NOT_FOUND;			break;
		case ERROR_BAD_FORMAT:        id = IDS_ERR_INVALID_EXE;				break;
		case SE_ERR_ACCESSDENIED:     id = IDS_ERR_CAN_NOT_ACCESS_FILE;		break;
		case SE_ERR_ASSOCINCOMPLETE:  id = IDS_ERR_INVALID_FILE_ASSOC;		break;
		case SE_ERR_DDEBUSY:          id = IDS_ERR_DDE_TRAN_CANT_COMPLETED; break;
		case SE_ERR_DDEFAIL:          id = IDS_ERR_DDE_TRAN_FAILED;			break;
		case SE_ERR_DDETIMEOUT:       id = IDS_ERR_DDE_TRAN_TIMEOUT;		break;
		case SE_ERR_DLLNOTFOUND:      id = IDS_ERR_DLL_NOT_FOUND;			break;
		case SE_ERR_NOASSOC:          id = IDS_ERR_NO_APP_ASSOC_WITH_EXT;	break;
		case SE_ERR_OOM:              id = IDS_ERR_NOT_ENOUGHT_MEMORY;		break;
		case SE_ERR_SHARE:            id = IDS_ERR_SHARE_VIOLATION;			break;
	}
	CString msg;
	if ( id )
		msg = uLoadString(id);
...
HINSTANCE CHyperLink::SendMailTo()
{
...
bool CHyperLink::GotoURL(LPCTSTR szURL)
{
	AFX_MANAGE_STATE( AfxGetStaticModuleState() );
