...
public:
	...
	BOOL SetBitmap(UINT nIDResource,
		EIconOptions eIconOptionsDef = ioSmallIcons,
		COLORREF clrMask = RGB_BACKGROUND);
	void SetButtons(int nNumButtons, TBBUTTONSETUP* lpButtons,
		ETextOptions eTextOptionsDef = toNoTextLabels);
	
// Attributes
public:
	BOOL IsCustomizeEnable() { return m_bIsCustomizeEnable; }
	...
	ETextOptions GetTextOptions() { return m_eTextOptions; }
	EIconOptions GetIconOptions() { return m_eIconOptions; }
