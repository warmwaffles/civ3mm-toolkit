...
class MFCAIDS_API CXPTheme
{
  private:
    ...
    typedef HRESULT(
      __stdcall* PFNDRAWTHEMEBACKGROUND)(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT* pRect, const RECT* pClipRect);
    ...
    typedef HRESULT(__stdcall* PFNGETTHEMEBACKGROUNDCONTENTRECT)(HTHEME hTheme,
                                                                 ...
                                                                 RECT* pContentRect);
    static HRESULT __stdcall GetThemeBackgroundContentRectFail(HTHEME hTheme,
                                                               HDC hdc,
                                                               int iPartId,
                                                               int iStateId,
                                                               const RECT* pBoundingRect,
    ...
    typedef HRESULT(__stdcall* PFNGETTHEMEBACKGROUNDEXTENT)(HTHEME hTheme,
                                                            ...
                                                            RECT* pExtentRect);
    static HRESULT __stdcall GetThemeBackgroundExtentFail(HTHEME hTheme,
                                                          HDC hdc,
                                                          int iPartId,
                                                          int iStateId,
                                                          const RECT* pContentRect,
    ...
    typedef HRESULT(
      __stdcall* PFNGETTHEMEPARTSIZE)(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, RECT* pRect, enum THEMESIZE eSize, SIZE* psz);
    ...
    typedef HRESULT(__stdcall* PFNGETTHEMETEXTEXTENT)(HTHEME hTheme,
                                                      HDC hdc,
                                                      int iPartId,
                                                      int iStateId,
                                                      LPCWSTR pszText,
                                                      ...
                                                      const RECT* pBoundingRect,
                                                      RECT* pExtentRect);
    static HRESULT __stdcall GetThemeTextExtentFail(HTHEME hTheme,
                                                    HDC hdc,
                                                    int iPartId,
                                                    int iStateId,
                                                    LPCWSTR pszText,
    ...
    static HRESULT __stdcall GetThemeTextMetricsFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, TEXTMETRIC* ptm)
    {
        return E_FAIL;
    }
    ...
    typedef HRESULT(
      __stdcall* PFNGETTHEMEBACKGROUNDREGION)(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT* pRect, HRGN* pRegion);
    static HRESULT __stdcall GetThemeBackgroundRegionFail(HTHEME hTheme,
                                                          HDC hdc,
                                                          int iPartId,
                                                          int iStateId,
                                                          const RECT* pRect,
    ...
    typedef HRESULT(__stdcall* PFNHITTESTTHEMEBACKGROUND)(HTHEME hTheme,
                                                          ...
                                                          POINT ptTest,
                                                          WORD* pwHitTestCode);
    static HRESULT __stdcall HitTestThemeBackgroundFail(HTHEME hTheme,
                                                        HDC hdc,
                                                        int iPartId,
                                                        int iStateId,
                                                        DWORD dwOptions,
    ...
    typedef HRESULT(__stdcall* PFNDRAWTHEMEEDGE)(HTHEME hTheme,
                                                 HDC hdc,
                                                 int iPartId,
                                                 int iStateId,
                                                 ...
                                                 UINT uFlags,
                                                 RECT* pContentRect);
    static HRESULT __stdcall DrawThemeEdgeFail(HTHEME hTheme,
                                               HDC hdc,
                                               int iPartId,
                                               int iStateId,
                                               const RECT* pDestRect,
    ...
    typedef HRESULT(
      __stdcall* PFNDRAWTHEMEICON)(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, const RECT* pRect, HIMAGELIST himl, int iImageIndex);
    static HRESULT __stdcall DrawThemeIconFail(HTHEME hTheme,
                                               HDC hdc,
                                               int iPartId,
                                               int iStateId,
                                               const RECT* pRect,
    ...
    static BOOL __stdcall IsThemePartDefinedFail(HTHEME hTheme, int iPartId, int iStateId)
    {
        return FALSE;
    }
    ...
    static BOOL __stdcall IsThemeBackgroundPartiallyTransparentFail(HTHEME hTheme, int iPartId, int iStateId)
    {
        return FALSE;
    }
    ...
    static HRESULT __stdcall GetThemeColorFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, COLORREF* pColor)
    {
        return E_FAIL;
    }
    ...
    static HRESULT __stdcall GetThemeMetricFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, int iPropId, int* piVal)
    {
        return E_FAIL;
    }
    ...
    typedef HRESULT(
      __stdcall* PFNGETTHEMESTRING)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, LPWSTR pszBuff, int cchMaxBuffChars);
    static HRESULT __stdcall GetThemeStringFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, LPWSTR pszBuff, int cchMaxBuffChars)
    {
        return E_FAIL;
    }
    ...
    static HRESULT __stdcall GetThemeBoolFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, BOOL* pfVal)
    {
        return E_FAIL;
    }
    ...
    static HRESULT __stdcall GetThemeIntFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, int* piVal)
    {
        return E_FAIL;
    }
    ...
    static HRESULT __stdcall GetThemeEnumValueFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, int* piVal)
    {
        return E_FAIL;
    }
    ...
    static HRESULT __stdcall GetThemePositionFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, POINT* pPoint)
    {
        return E_FAIL;
    }
    ...
    static HRESULT __stdcall GetThemeFontFail(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, int iPropId, LOGFONT* pFont)
    {
        return E_FAIL;
    }
    ...
    static HRESULT __stdcall GetThemeRectFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, RECT* pRect)
    {
        return E_FAIL;
    }
    ...
    typedef HRESULT(
      __stdcall* PFNGETTHEMEMARGINS)(HTHEME hTheme, HDC hdc, int iPartId, int iStateId, int iPropId, RECT* prc, MARGINS* pMargins);
    static HRESULT __stdcall GetThemeMarginsFail(HTHEME hTheme,
                                                 HDC hdc,
                                                 int iPartId,
                                                 int iStateId,
                                                 int iPropId,
    ...
    static HRESULT __stdcall GetThemeIntListFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, INTLIST* pIntList)
    {
        return E_FAIL;
    }
    ...
    typedef HRESULT(
      __stdcall* PFNGETTHEMEPROPERTYORIGIN)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, enum PROPERTYORIGIN* pOrigin);
    static HRESULT __stdcall GetThemePropertyOriginFail(HTHEME hTheme, int iPartId, int iStateId, int iPropId, enum PROPERTYORIGIN* pOrigin)
    {
        return E_FAIL;
    }
    ...
    static HRESULT __stdcall SetWindowThemeFail(HWND hwnd, LPCWSTR pszSubAppName, LPCWSTR pszSubIdList)
    {
        return E_FAIL;
    }
    ...
    typedef HRESULT(
      __stdcall* PFNGETTHEMEFILENAME)(HTHEME hTheme, int iPartId, int iStateId, int iPropId, LPWSTR pszThemeFileName, int cchMaxBuffChars);
    static HRESULT __stdcall GetThemeFilenameFail(HTHEME hTheme,
                                                  int iPartId,
                                                  int iStateId,
                                                  int iPropId,
    ...
    static HRESULT __stdcall GetThemeSysStringFail(HTHEME hTheme, int iStringId, LPWSTR pszStringBuff, int cchMaxStringChars)
    {
        return E_FAIL;
    }
    ...
    typedef HRESULT(__stdcall* PFNGETCURRENTTHEMENAME)(LPWSTR pszThemeFileName,
                                                       int cchMaxNameChars,
                                                       LPWSTR pszColorBuff,
                                                       int cchMaxColorChars,
                                                       LPWSTR pszSizeBuff,
                                                       int cchMaxSizeChars);
    static HRESULT __stdcall GetCurrentThemeNameFail(LPWSTR pszThemeFileName,
                                                     int cchMaxNameChars,
                                                     LPWSTR pszColorBuff,
                                                     int cchMaxColorChars,
                                                     LPWSTR pszSizeBuff,
  ...
  public:
    ...
    void Close();
    HRESULT DrawBackground(HDC hdc, int iPartId, int iStateId, const RECT* pRect, const RECT* pClipRect);
    HRESULT
    DrawText(HDC hdc, int iPartId, int iStateId, LPCWSTR pszText, int iCharCount, DWORD dwTextFlags, DWORD dwTextFlags2, const RECT* pRect);
    HRESULT GetBackgroundContentRect(HDC hdc, int iPartId, int iStateId, const RECT* pBoundingRect, RECT* pContentRect);
    HRESULT GetBackgroundExtent(HDC hdc, int iPartId, int iStateId, const RECT* pContentRect, RECT* pExtentRect);
    HRESULT GetPartSize(HDC hdc, int iPartId, int iStateId, RECT* pRect, enum THEMESIZE eSize, SIZE* psz);
    HRESULT GetTextExtent(HDC hdc,
                          ...
                          const RECT* pBoundingRect,
                          RECT* pExtentRect);
    HRESULT GetTextMetrics(HDC hdc, int iPartId, int iStateId, TEXTMETRIC* ptm);
    HRESULT GetBackgroundRegion(HDC hdc, int iPartId, int iStateId, const RECT* pRect, HRGN* pRegion);
    HRESULT
    HitTestBackground(HDC hdc, int iPartId, int iStateId, DWORD dwOptions, const RECT* pRect, HRGN hrgn, POINT ptTest, WORD* pwHitTestCode);
    HRESULT DrawEdge(HDC hdc, int iPartId, int iStateId, const RECT* pDestRect, UINT uEdge, UINT uFlags, RECT* pContentRect);
    HRESULT DrawIcon(HDC hdc, int iPartId, int iStateId, const RECT* pRect, HIMAGELIST himl, int iImageIndex);
    BOOL IsPartDefined(int iPartId, int iStateId);
    BOOL IsBackgroundPartiallyTransparent(int iPartId, int iStateId);
    HRESULT GetColor(int iPartId, int iStateId, int iPropId, COLORREF* pColor);
    HRESULT GetMetric(HDC hdc, int iPartId, int iStateId, int iPropId, int* piVal);
    HRESULT GetString(int iPartId, int iStateId, int iPropId, LPWSTR pszBuff, int cchMaxBuffChars);
    HRESULT GetBool(int iPartId, int iStateId, int iPropId, BOOL* pfVal);
    HRESULT GetInt(int iPartId, int iStateId, int iPropId, int* piVal);
    HRESULT GetEnumValue(int iPartId, int iStateId, int iPropId, int* piVal);
    HRESULT GetPosition(int iPartId, int iStateId, int iPropId, POINT* pPoint);
    HRESULT GetFont(HDC hdc, int iPartId, int iStateId, int iPropId, LOGFONT* pFont);
    HRESULT GetRect(int iPartId, int iStateId, int iPropId, RECT* pRect);
    HRESULT GetMargins(HDC hdc, int iPartId, int iStateId, int iPropId, RECT* prc, MARGINS* pMargins);
    HRESULT GetIntList(int iPartId, int iStateId, int iPropId, INTLIST* pIntList);
    HRESULT GetPropertyOrigin(int iPartId, int iStateId, int iPropId, enum PROPERTYORIGIN* pOrigin);
    static HRESULT SetWindowTheme(HWND hwnd, LPCWSTR pszSubAppName, LPCWSTR pszSubIdList);
    HRESULT GetFilename(int iPartId, int iStateId, int iPropId, LPWSTR pszThemeFileName, int cchMaxBuffChars);
    ...
    HRESULT GetSysString(int iStringId, LPWSTR pszStringBuff, int cchMaxStringChars);
    ...
    static HRESULT GetCurrentName(LPWSTR pszThemeFileName,
                                  int cchMaxNameChars,
                                  LPWSTR pszColorBuff,
                                  int cchMaxColorChars,
                                  LPWSTR pszSizeBuff,
                                  int cchMaxSizeChars);
    static HRESULT GetDocumentationProperty(LPCWSTR pszThemeName, LPCWSTR pszPropertyName, LPWSTR pszValueBuff, int cchMaxValChars);
