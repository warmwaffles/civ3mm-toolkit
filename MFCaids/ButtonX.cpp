...
void
CButtonX::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
...
void
CButtonX::OnMouseMove(UINT nFlags, CPoint point)
{
    if (!m_bMouseOver) {
        m_bMouseOver = TRUE;
...
//
void
CButtonX::DrawArrow(CDC* pDC, RECT* rpItem)
{
    CRect rect;
#ifdef _THEME_H_
    if (m_xpButton->IsAppThemed())
...
//
void
CButtonX::SetTooltipText(int nText, BOOL bActivate)
{
    CString sText;
...
//
void
CButtonX::SetTooltipText(LPCTSTR lpszText, BOOL bActivate)
{
...
//
void
CButtonX::ActivateTooltip(BOOL bActivate)
{
...
BOOL
CButtonX::PreTranslateMessage(MSG* pMsg)
{
    InitToolTip();
...
//
BOOL
CButtonX::SetAlign(BYTE byAlign, BOOL bRepaint)
{
    switch (byAlign) {
        case BX_ALIGN_LEFT:
        case BX_ALIGN_RIGHT:
...
//
void
CButtonX::PrepareImageRect(BOOL bHasCaption, RECT* rpItem, CRect* rpCaption, DWORD dwWidth, DWORD dwHeight, CRect* rpImage)
{
...
void
CButtonX::DrawTheIcon(CDC* pDC, BOOL bHasCaption, RECT* rpItem, CRect* rpCaption)
{
    CRect rImage;
...
//
BOOL
CButtonX::SetIcon(UINT nIDResource)
{
    if (!nIDResource) {
...
//
BOOL
CButtonX::SetIcon(HICON hIcon /*=NULL*/)
{
    // Free any loaded resource
    FreeResources();
...
void
CButtonX::FreeResources(BOOL bCheckForNULL /*=TRUE*/)
{
...
//
HICON
CButtonX::CreateGrayscaleIcon(HICON hIcon)
{
...
//
void
CButtonX::DrawTheText(CDC* pDC, RECT* rpItem, CRect* rpCaption)
{
...
#ifdef _THEME_H_
    if (m_xpButton->IsAppThemed() && (!m_bIsColorChanged || m_bIsDisabled)) {
        ...
        m_xpButton->DrawText(pDC->GetSafeHdc(), BP_PUSHBUTTON, m_bIsDisabled ? PBS_DISABLED : 0, lpCaption, -1, m_nFormat, 0, rpCaption);
    } else
#endif // _THEME_H_
    {
#ifdef _THEME_H_
...
//
void
CButtonX::SetDefaultColors(BOOL bRepaint /*=TRUE*/)
{
...
//
BOOL
CButtonX::SetTextColor(BYTE byColorIndex, COLORREF crColor, BOOL bRepaint /*=TRUE*/)
{
...
//
void
CButtonX::SetTextColors(COLORREF crColorIn /*=NULL*/,
                        COLORREF crColorOut /*=NULL*/,
                        COLORREF crColorFocus /*=NULL*/,
                        BOOL bRepaint /*=TRUE*/)
{
...
BOOL
CButtonX::OnSetCursor(CWnd* pWnd, UINT nHitTest, UINT message)
{
...
//
BOOL
CButtonX::SetBtnCursor(int nCursorId, BOOL bRepaint /*=TRUE*/)
{
    HINSTANCE hInstResource = NULL;
...
//
void
CButtonX::SetTextColorIn(COLORREF crColor, BOOL bRepaint /*= TRUE*/)
{
...
//
void
CButtonX::SetTextColorOut(COLORREF crColor, BOOL bRepaint /*= TRUE*/)
{
...
//
void
CButtonX::SetTextColorFocus(COLORREF crColor, BOOL bRepaint /*= TRUE*/)
{
...
//
void
CButtonX::SetShowText(BOOL bShow /*=TRUE*/, BOOL bRepaint /*=TRUE*/)
{
    m_bShowText = bShow;
...
//
void
CButtonX::SetShowIcon(BOOL bShow /*=TRUE*/, BOOL bRepaint /*=TRUE*/)
{
    m_bShowIcon = bShow;
...
//
void
CButtonX::SetShowIconOnly(BOOL bShow /*=TRUE*/, BOOL bRepaint /*=TRUE*/)
{
...
#ifdef BX_USE_SOUND
void
CButtonX::SetSound(LPCTSTR lpszSound, HMODULE hMod, BOOL bPlayOnClick, BOOL bPlayAsync)
{
...
LRESULT
CButtonX::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
    switch (message) {
#ifdef _THEME_H_
...
//
LRESULT
CButtonX::OnBxpSettingChange(WPARAM wParam, LPARAM lParam)
{
...
//
void
CButtonX::SetSettings(UINT nFlags /*=0*/)
{
    m_nSettings = nFlags;
    ...
    } else if (!(nStyle & BS_OWNERDRAW) && !(m_nSettings & BX_OFF_OWNERDRAW)) {
        nStyle |= BS_OWNERDRAW;
        SetButtonStyle(nStyle);
    }
...
//
void
CButtonX::SetButtonsSettings(UINT nFlags /*=0*/)
{
    m_nSettings = nFlags;
}
...
int
CButtonX::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
