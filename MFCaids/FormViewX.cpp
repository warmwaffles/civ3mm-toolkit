...
void
CFormViewX::DoDataExchange(CDataExchange* pDX)
{
...
void
CFormViewX::OnSize(UINT nType, int cx, int cy)
{
...
void
CFormViewX::SetControlInfo(UINT CtrlId,
                           WORD Anchor,
                           WORD xDivider,
                           WORD xDivPos,
                           WORD yDivider,
...
BOOL
CFormViewX::GetControlPos(UINT CtrlId, CRect& pos)
{
    int id;
...
void
CFormViewX::SetControlPos(UINT CtrlId, CRect& pos)
{
    int id;
    if ((id = FindCtrl(CtrlId)) == -1)
        return;
...
int
CFormViewX::FindCtrl(UINT CtrlId)
{
    for (int i = 0; i < m_CtrlInfo.GetSize(); i++)
