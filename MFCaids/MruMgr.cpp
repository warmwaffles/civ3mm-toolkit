...
{
    CRecentFileList2* prfl = new CRecentFileList2(nBaseID, lpszSection, lpszEntryFormat, pMruFn, nMaxMRU, nMaxDispLen, nStart);
...
//
BOOL
CMruFileManager::Remove(DWORD dwRfl)
{
...
//
void
CMruFileManager::OnUpdateRecentFileMenu(CCmdUI* pCmdUI)
{
...
//
BOOL
CMruFileManager::OnOpenRecentFile(UINT nID)
{
...
//
CRecentFileList2*
CMruFileManager::FindRFL(UINT nID)
{
...
//
BOOL
CMruFileManager::AddToRecentFileList(LPCTSTR lpszPathName)
{
...
CRecentFileList2::CRecentFileList2(UINT nBaseID,
                                   LPCTSTR lpszSection,
...
//
BOOL
CRecentFileList2::IsMyKindOfFile(LPCTSTR lpszPathName)
{
...
//
void
CRecentFileList2::UpdateMenu(CCmdUI* pCmdUI)
{
    ...
    for (iMRU = 0; iMRU < m_nSize; iMRU++) {
        ...
        *lpszDest = 0;
        ...
        pCmdUI->m_pMenu->InsertMenu(pCmdUI->m_nIndex++, MF_STRING | MF_BYPOSITION, pCmdUI->m_nID++, CString(buf) + sTemp);
    }
...
//
void
CMruFileManager::RemoveMRUFileLists()
{
