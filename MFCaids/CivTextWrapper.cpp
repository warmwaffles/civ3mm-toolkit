...
CString Txt2Rtf(LPCTSTR sTxt)
{
	...
	return uFormatString(IDS_RTF_SEGMENT, 
		uLoadString(IDS_RTF_MAIN) + 
		" " +
		uLoadString(IDS_RTF_COLOR_TABLE) + 
		sTxt);
}

void MakeCivFormat(CString& sTxt)
{
