...
int MFCAIDS_API XMessageBox(HWND hwnd,
                            LPCTSTR lpszMessage,
                            LPCTSTR lpszCaption = NULL,
                            UINT nStyle         = MB_OK | MB_ICONEXCLAMATION,
                            XMSGBOXPARAMS* pXMB = NULL);

int MFCAIDS_API XMessageBox(HWND hwnd, UINT nIDPrompt, UINT nStyle = MB_OK | MB_ICONEXCLAMATION, XMSGBOXPARAMS* pXMB = NULL);

int MFCAIDS_API XMessageBox(HWND hwnd, LPCTSTR lpszMessage, UINT nStyle = MB_OK | MB_ICONEXCLAMATION, XMSGBOXPARAMS* pXMB = NULL);

int MFCAIDS_API XMessageBox(LPCTSTR lpszMessage,
                            LPCTSTR lpszCaption = NULL,
                            UINT nStyle         = MB_OK | MB_ICONEXCLAMATION,
                            XMSGBOXPARAMS* pXMB = NULL);

int MFCAIDS_API XMessageBox(UINT nIDPrompt, UINT nStyle = MB_OK | MB_ICONEXCLAMATION, XMSGBOXPARAMS* pXMB = NULL);

int MFCAIDS_API XMessageBox(LPCTSTR lpszMessage, UINT nStyle = MB_OK | MB_ICONEXCLAMATION, XMSGBOXPARAMS* pXMB = NULL);
