...
void*
CXPTheme::GetProc(LPCSTR szProc, void* pfnFail)
{
    void* pRet = pfnFail;
    if (m_hThemeDll == NULL && !m_bLoaded) {
        m_hThemeDll = LoadLibrary(_T("UxTheme.dll"));
...
BOOL
CXPTheme::Open(HWND hwnd, LPCWSTR pszClassList)
{
...
HRESULT
CXPTheme::DrawBackground(HDC hdc, int iPartId, int iStateId, const RECT* pRect, const RECT* pClipRect)
{
    if (m_pDrawThemeBackground == NULL)
        m_pDrawThemeBackground = (CXPTheme::PFNDRAWTHEMEBACKGROUND)GetProc("DrawThemeBackground", (void*)DrawThemeBackgroundFail);
    return (*m_pDrawThemeBackground)(m_hTheme, hdc, iPartId, iStateId, pRect, pClipRect);
}

HRESULT
CXPTheme::DrawText(HDC hdc,
                   int iPartId,
                   int iStateId,
                   LPCWSTR pszText,
                   int iCharCount,
...
HRESULT
CXPTheme::GetBackgroundContentRect(HDC hdc, int iPartId, int iStateId, const RECT* pBoundingRect, RECT* pContentRect)
{
    if (m_pGetThemeBackgroundContentRect == NULL)
        m_pGetThemeBackgroundContentRect =
          (CXPTheme::PFNGETTHEMEBACKGROUNDCONTENTRECT)GetProc("GetThemeBackgroundContentRect", (void*)GetThemeBackgroundContentRectFail);
    return (*m_pGetThemeBackgroundContentRect)(m_hTheme, hdc, iPartId, iStateId, pBoundingRect, pContentRect);
}
HRESULT
CXPTheme::GetBackgroundExtent(HDC hdc, int iPartId, int iStateId, const RECT* pContentRect, RECT* pExtentRect)
{
    if (m_pGetThemeBackgroundExtent == NULL)
        m_pGetThemeBackgroundExtent =
          (CXPTheme::PFNGETTHEMEBACKGROUNDEXTENT)GetProc("GetThemeBackgroundExtent", (void*)GetThemeBackgroundExtentFail);
    return (*m_pGetThemeBackgroundExtent)(m_hTheme, hdc, iPartId, iStateId, pContentRect, pExtentRect);
}
HRESULT
CXPTheme::GetPartSize(HDC hdc, int iPartId, int iStateId, RECT* pRect, enum THEMESIZE eSize, SIZE* psz)
{
    if (m_pGetThemePartSize == NULL)
        m_pGetThemePartSize = (CXPTheme::PFNGETTHEMEPARTSIZE)GetProc("GetThemePartSize", (void*)GetThemePartSizeFail);
    return (*m_pGetThemePartSize)(m_hTheme, hdc, iPartId, iStateId, pRect, eSize, psz);
}

HRESULT
CXPTheme::GetTextExtent(HDC hdc,
                        int iPartId,
                        int iStateId,
                        LPCWSTR pszText,
                        int iCharCount,
...
HRESULT
CXPTheme::GetTextMetrics(HDC hdc, int iPartId, int iStateId, TEXTMETRIC* ptm)
{
...
HRESULT
CXPTheme::GetBackgroundRegion(HDC hdc, int iPartId, int iStateId, const RECT* pRect, HRGN* pRegion)
{
    if (m_pGetThemeBackgroundRegion == NULL)
        m_pGetThemeBackgroundRegion =
          (CXPTheme::PFNGETTHEMEBACKGROUNDREGION)GetProc("GetThemeBackgroundRegion", (void*)GetThemeBackgroundRegionFail);
    return (*m_pGetThemeBackgroundRegion)(m_hTheme, hdc, iPartId, iStateId, pRect, pRegion);
}

HRESULT
CXPTheme::HitTestBackground(HDC hdc,
                            int iPartId,
                            int iStateId,
                            DWORD dwOptions,
                            const RECT* pRect,
                            ...
                            WORD* pwHitTestCode)
{
    if (m_pHitTestThemeBackground == NULL)
        m_pHitTestThemeBackground =
          (CXPTheme::PFNHITTESTTHEMEBACKGROUND)GetProc("HitTestThemeBackground", (void*)HitTestThemeBackgroundFail);
    return (*m_pHitTestThemeBackground)(m_hTheme, hdc, iPartId, iStateId, dwOptions, pRect, hrgn, ptTest, pwHitTestCode);
}

HRESULT
CXPTheme::DrawEdge(HDC hdc, int iPartId, int iStateId, const RECT* pDestRect, UINT uEdge, UINT uFlags, RECT* pContentRect)
{
...
HRESULT
CXPTheme::DrawIcon(HDC hdc, int iPartId, int iStateId, const RECT* pRect, HIMAGELIST himl, int iImageIndex)
{
...
BOOL
CXPTheme::IsPartDefined(int iPartId, int iStateId)
{
...
BOOL
CXPTheme::IsBackgroundPartiallyTransparent(int iPartId, int iStateId)
{
    if (m_pIsThemeBackgroundPartiallyTransparent == NULL)
        m_pIsThemeBackgroundPartiallyTransparent = (CXPTheme::PFNISTHEMEBACKGROUNDPARTIALLYTRANSPARENT)GetProc(
          "IsThemeBackgroundPartiallyTransparent", (void*)IsThemeBackgroundPartiallyTransparentFail);
    return (*m_pIsThemeBackgroundPartiallyTransparent)(m_hTheme, iPartId, iStateId);
}

HRESULT
CXPTheme::GetColor(int iPartId, int iStateId, int iPropId, COLORREF* pColor)
{
...
HRESULT
CXPTheme::GetMetric(HDC hdc, int iPartId, int iStateId, int iPropId, int* piVal)
{
...
HRESULT
CXPTheme::GetString(int iPartId, int iStateId, int iPropId, LPWSTR pszBuff, int cchMaxBuffChars)
{
...
HRESULT
CXPTheme::GetBool(int iPartId, int iStateId, int iPropId, BOOL* pfVal)
{
...
HRESULT
CXPTheme::GetInt(int iPartId, int iStateId, int iPropId, int* piVal)
{
...
HRESULT
CXPTheme::GetEnumValue(int iPartId, int iStateId, int iPropId, int* piVal)
{
...
HRESULT
CXPTheme::GetPosition(int iPartId, int iStateId, int iPropId, POINT* pPoint)
{
...
HRESULT
CXPTheme::GetFont(HDC hdc, int iPartId, int iStateId, int iPropId, LOGFONT* pFont)
{
...
HRESULT
CXPTheme::GetRect(int iPartId, int iStateId, int iPropId, RECT* pRect)
{
...
HRESULT
CXPTheme::GetMargins(HDC hdc, int iPartId, int iStateId, int iPropId, RECT* prc, MARGINS* pMargins)
{
...
HRESULT
CXPTheme::GetIntList(int iPartId, int iStateId, int iPropId, INTLIST* pIntList)
{
...
HRESULT
CXPTheme::GetPropertyOrigin(int iPartId, int iStateId, int iPropId, enum PROPERTYORIGIN* pOrigin)
{
    if (m_pGetThemePropertyOrigin == NULL)
        m_pGetThemePropertyOrigin =
          (CXPTheme::PFNGETTHEMEPROPERTYORIGIN)GetProc("GetThemePropertyOrigin", (void*)GetThemePropertyOriginFail);
    return (*m_pGetThemePropertyOrigin)(m_hTheme, iPartId, iStateId, iPropId, pOrigin);
}

HRESULT
CXPTheme::SetWindowTheme(HWND hwnd, LPCWSTR pszSubAppName, LPCWSTR pszSubIdList)
{
...
HRESULT
CXPTheme::GetFilename(int iPartId, int iStateId, int iPropId, LPWSTR pszThemeFileName, int cchMaxBuffChars)
{
...
COLORREF
CXPTheme::GetSysColor(int iColorId)
{
...
HBRUSH
CXPTheme::GetSysColorBrush(int iColorId)
{
...
BOOL
CXPTheme::GetSysBool(int iBoolId)
{
...
int
CXPTheme::GetSysSize(int iSizeId)
{
...
HRESULT
CXPTheme::GetSysFont(int iFontId, LOGFONT* plf)
{
...
HRESULT
CXPTheme::GetSysString(int iStringId, LPWSTR pszStringBuff, int cchMaxStringChars)
{
...
HRESULT
CXPTheme::GetSysInt(int iIntId, int* piValue)
{
...
HTHEME
CXPTheme::GetWindowTheme(HWND hwnd)
{
...
HRESULT
CXPTheme::EnableDialogTexture(HWND hwnd, DWORD dwFlags)
{
    if (m_pEnableThemeDialogTexture == NULL)
        m_pEnableThemeDialogTexture =
          (CXPTheme::PFNENABLETHEMEDIALOGTEXTURE)GetProc("EnableThemeDialogTexture", (void*)EnableThemeDialogTextureFail);
    return (*m_pEnableThemeDialogTexture)(hwnd, dwFlags);
}

BOOL
CXPTheme::IsDialogTextureEnabled(HWND hwnd)
{
    if (m_pIsThemeDialogTextureEnabled == NULL)
        m_pIsThemeDialogTextureEnabled =
          (CXPTheme::PFNISTHEMEDIALOGTEXTUREENABLED)GetProc("IsThemeDialogTextureEnabled", (void*)IsThemeDialogTextureEnabledFail);
    return (*m_pIsThemeDialogTextureEnabled)(hwnd);
}

DWORD
CXPTheme::GetAppProperties()
{
...
void
CXPTheme::SetAppProperties(DWORD dwFlags)
{
...
HRESULT
CXPTheme::GetCurrentName(LPWSTR pszThemeFileName,
                         int cchMaxNameChars,
                         LPWSTR pszColorBuff,
...
HRESULT
CXPTheme::GetDocumentationProperty(LPCWSTR pszThemeName, LPCWSTR pszPropertyName, LPWSTR pszValueBuff, int cchMaxValChars)
{
    if (m_pGetThemeDocumentationProperty == NULL)
        m_pGetThemeDocumentationProperty =
          (CXPTheme::PFNGETTHEMEDOCUMENTATIONPROPERTY)GetProc("GetThemeDocumentationProperty", (void*)GetThemeDocumentationPropertyFail);
    return (*m_pGetThemeDocumentationProperty)(pszThemeName, pszPropertyName, pszValueBuff, cchMaxValChars);
}

HRESULT
CXPTheme::DrawParentBackground(HWND hwnd, HDC hdc, RECT* prc)
{
    if (m_pDrawThemeParentBackground == NULL)
        m_pDrawThemeParentBackground =
          (CXPTheme::PFNDRAWTHEMEPARENTBACKGROUND)GetProc("DrawThemeParentBackground", (void*)DrawThemeParentBackgroundFail);
    return (*m_pDrawThemeParentBackground)(hwnd, hdc, prc);
}

HRESULT
CXPTheme::EnableTheming(BOOL fEnable)
{
