...
L_INT EXT_FUNCTION L_AppendPlayback(HPLAYBACK hPlayback, pBITMAPHANDLE pBitmap);
...
HBITMAP EXT_FUNCTION L_ChangeToDDB(HDC hDC, pBITMAPHANDLE pBitmap);
...
L_INT EXT_FUNCTION
L_ConvertColorSpace(L_UCHAR L_FAR* pBufferSrc, L_UCHAR L_FAR* pBufferDst, L_INT nWidth, L_INT nFormatSrc, L_INT nFormatDst);

L_INT EXT_FUNCTION L_ConvertFromDDB(HDC hDC, pBITMAPHANDLE pBitmap, HBITMAP hBitmap, HPALETTE hPalette);

HBITMAP EXT_FUNCTION L_ConvertToDDB(HDC hDC, pBITMAPHANDLE pBitmap);

L_BOOL EXT_FUNCTION L_CopyFromClipboard(HWND hWnd, pBITMAPHANDLE pBitmap);

L_BOOL EXT_FUNCTION L_CopyToClipboard(HWND hWnd, pBITMAPHANDLE pBitmap);
...
L_INT EXT_FUNCTION L_CreateMaskFromBitmapRgn(pBITMAPHANDLE pBitmap, pBITMAPHANDLE pMask);

L_INT EXT_FUNCTION L_CreatePlayback(pHPLAYBACK phPlayback, pBITMAPHANDLE pBitmap, HBITMAPLIST hList);

L_INT EXT_FUNCTION L_DestroyPlayback(HPLAYBACK hPlayback, pHBITMAPLIST phList);

L_INT EXT_FUNCTION L_FrameBitmapRgn(HDC hDC, pBITMAPHANDLE pBitmap, pRGNXFORM pXForm, L_UINT uType);

L_INT EXT_FUNCTION L_ColorBitmapRgn(HDC hDC, pBITMAPHANDLE pBitmap, pRGNXFORM pXForm, COLORREF crRgnColor);

L_INT EXT_FUNCTION L_FreeBitmapRgn(pBITMAPHANDLE pBitmap);

L_INT EXT_FUNCTION L_GetBitmapRgnArea(pBITMAPHANDLE pBitmap, L_UINT32 L_FAR* puArea);

L_INT EXT_FUNCTION L_GetBitmapRgnBounds(pBITMAPHANDLE pBitmap, pRGNXFORM pXForm, RECT L_FAR* pRect);

L_INT EXT_FUNCTION L_GetBitmapRgnHandle(pBITMAPHANDLE pBitmap, pRGNXFORM pXForm, HRGN L_FAR* phRgn);
...
L_INT EXT_FUNCTION L_GetPlaybackDelay(HPLAYBACK hPlayback, L_UINT32 L_FAR* puDelay);

L_INT EXT_FUNCTION L_GetPlaybackIndex(HPLAYBACK hPlayback, L_INT L_FAR* pnIndex);

L_INT EXT_FUNCTION L_GetPlaybackState(HPLAYBACK hPlayback, L_UINT L_FAR* puState);

L_INT EXT_FUNCTION L_GetPlaybackUpdateRect(HPLAYBACK hPlayback, LPRECT prcUpdate, L_BOOL fClear);

L_INT EXT_FUNCTION L_HalfToneBitmap(pBITMAPHANDLE pBitmap, L_UINT uType);

L_INT EXT_FUNCTION L_HalfToneBitmapExt(pBITMAPHANDLE pBitmap, L_UINT uType, L_INT32 nAngle);

L_BOOL EXT_FUNCTION L_IsPtInBitmapRgn(pBITMAPHANDLE pBitmap, L_INT nRow, L_INT nCol);

L_INT EXT_FUNCTION L_OffsetBitmapRgn(pBITMAPHANDLE pBitmap, L_INT nRowOffset, L_INT nColOffset);

L_INT EXT_FUNCTION L_PaintDC(HDC hDC, pBITMAPHANDLE pBitmap, LPRECT pSrc, LPRECT pClipSrc, LPRECT pDst, LPRECT pClipDst, L_UINT32 uROP3);
...
L_INT EXT_FUNCTION L_PaintRgnDC(HDC hDC, pBITMAPHANDLE pBitmap, LPRECT pSrc, LPRECT pClipSrc, LPRECT pDst, LPRECT pClipDst, L_UINT32 uROP3);
...
HDC EXT_FUNCTION L_PrintBitmap(pBITMAPHANDLE pBitmap, L_INT nX, L_INT nY, L_INT nWidth, L_INT nHeight, L_BOOL fEndDoc);

HDC EXT_FUNCTION L_PrintBitmapExt(HDC hDC, pBITMAPHANDLE pBitmap, L_INT nX, L_INT nY, L_INT nWidth, L_INT nHeight, L_BOOL fEndDoc);

HDC EXT_FUNCTION L_PrintBitmapFast(HDC hDC, pBITMAPHANDLE pBitmap, L_INT nX, L_INT nY, L_INT nWidth, L_INT nHeight, L_BOOL fEndDoc);

L_INT EXT_FUNCTION L_ProcessPlayback(HPLAYBACK hPlayback, L_UINT L_FAR* puState);

L_INT EXT_FUNCTION L_ScreenCaptureBitmap(HDC hDC, pBITMAPHANDLE pBitmap, LPRECT pRect);

L_INT EXT_FUNCTION L_SetBitmapRgnColor(pBITMAPHANDLE pBitmap, COLORREF crColor, L_UINT uCombineMode);

L_INT EXT_FUNCTION L_SetBitmapRgnColorHSVRange(pBITMAPHANDLE pBitmap, HSVREF hsvLower, HSVREF hsvUpper, L_UINT uCombineMode);

L_INT EXT_FUNCTION L_SetBitmapRgnColorRGBRange(pBITMAPHANDLE pBitmap, COLORREF crLower, COLORREF crUpper, L_UINT uCombineMode);
...
#ifdef WIN32
L_INT EXT_FUNCTION L_SetBitmapRgnMagicWand(pBITMAPHANDLE pBitmap, L_INT x, L_INT y, L_UCHAR uTolerance, L_UINT uCombineMode);
#endif

L_INT EXT_FUNCTION L_SetBitmapRgnEllipse(pBITMAPHANDLE pBitmap, pRGNXFORM pXForm, RECT L_FAR* pRect, L_UINT uCombineMode);

L_INT EXT_FUNCTION L_SetBitmapRgnFromMask(pBITMAPHANDLE pBitmap, pRGNXFORM pXForm, pBITMAPHANDLE pMask, L_UINT uCombineMode);

L_INT EXT_FUNCTION L_SetBitmapRgnHandle(pBITMAPHANDLE pBitmap, pRGNXFORM pXForm, HRGN hRgn, L_UINT uCombineMode);

L_INT EXT_FUNCTION
L_SetBitmapRgnPolygon(pBITMAPHANDLE pBitmap, pRGNXFORM pXForm, POINT L_FAR* pPoints, L_UINT uPoints, L_UINT uFillMode, L_UINT uCombineMode);

L_INT EXT_FUNCTION L_SetBitmapRgnRect(pBITMAPHANDLE pBitmap, pRGNXFORM pXForm, RECT L_FAR* pRect, L_UINT uCombineMode);
...
L_UINT32 EXT_FUNCTION L_SetDisplayMode(L_UINT32 uFlagPos, L_UINT32 uFlagSet);

L_INT EXT_FUNCTION L_SetPaintContrast(pBITMAPHANDLE pBitmap, L_INT nValue);

L_INT EXT_FUNCTION L_SetPaintGamma(pBITMAPHANDLE pBitmap, L_UINT uValue);

L_INT EXT_FUNCTION L_SetPaintIntensity(pBITMAPHANDLE pBitmap, L_INT nValue);

L_INT EXT_FUNCTION L_SetPlaybackIndex(HPLAYBACK hPlayback, L_INT nIndex);

L_INT EXT_FUNCTION L_UnderlayBitmap(pBITMAPHANDLE pBitmapDst, pBITMAPHANDLE pUnderlay, L_UINT uFlags);

L_INT EXT_FUNCTION L_ValidatePlaybackLines(HPLAYBACK hPlayback, L_INT nRow, L_INT nLines);

L_INT EXT_FUNCTION
L_WindowLevel(pBITMAPHANDLE pBitmap, L_INT nLowBit, L_INT nHighBit, L_RGBQUAD L_HUGE* pLUT, L_UINT32 ulLUTLength, L_UINT uFlags);
...
/* exported functions */
L_INT EXT_FUNCTION L_CreatePanWindow(HWND hWndParent,
                                     pBITMAPHANDLE pBitmap,
...
#define DISPLAYMODE_INVALIDATEPAN 0x10000000
L_INT EXT_FUNCTION
L_UpdatePanWindow(HWND hPanWindow, pBITMAPHANDLE pBitmap, L_UINT32 ulDisplayFlags, COLORREF crPen, LPCSTR pszTitle, LPRECT prcDst);
...
L_INT EXT_FUNCTION L_ConvertFromWMF(pBITMAPHANDLE pBitmap, HMETAFILE hWmf, L_UINT uWidth, L_UINT uHeight);

L_INT EXT_FUNCTION L_ChangeFromWMF(pBITMAPHANDLE pBitmap, HMETAFILE hWmf, L_UINT uWidth, L_UINT uHeight);
...
#ifdef WIN32
L_INT EXT_FUNCTION L_ConvertFromEMF(pBITMAPHANDLE pBitmap, HENHMETAFILE hWmf, L_UINT uWidth, L_UINT uHeight);

L_INT EXT_FUNCTION L_ChangeFromEMF(pBITMAPHANDLE pBitmap, HENHMETAFILE hWmf, L_UINT uWidth, L_UINT uHeight);
...
L_INT EXT_FUNCTION L_StartMagGlass(HWND hWnd,
                                   pBITMAPHANDLE pBitmap,
                                   RECT L_FAR* prcDst,
                                   L_INT32 nWidth,
                                   L_INT32 nHeight,
...
L_INT EXT_FUNCTION L_StartMagGlassExt(HWND hWnd,
                                      pBITMAPHANDLE pBitmap,
                                      RECT L_FAR* prcDst,
                                      L_INT32 nWidth,
                                      L_INT32 nHeight,
