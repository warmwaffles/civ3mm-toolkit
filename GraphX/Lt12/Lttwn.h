...
#define TWAIN_SHOWSTATUS                                                                                                                   \
    0x0002                      /* Show the Status Indicator, if it
                                             is selectable */
...
#define TWAIN_PIX_GRAY                                                                                                                     \
    1                   /* GrayScale, 4 or 8 bits per pixel,
                                          the largest supported value. */
#define TWAIN_PIX_RGB 2 /* Color, 24 bits per pixel. */
#define TWAIN_PIX_PALETTE                                                                                                                  \
    3 /* Color, 4 or 8 bits per pixel, the
...
L_INT EXT_FUNCTION L_TwainAcquireExt(HWND hWnd, pBITMAPHANDLE pBitmap, L_UINT uFlags, TWAINCALLBACK pfnCallback, L_VOID L_FAR* pUserData);

L_INT EXT_FUNCTION L_TwainCloseSession(HWND hWnd);

L_INT EXT_FUNCTION L_TwainEnumSources(HWND hWnd, ENUMSOURCECALLBACK pfnCallback, L_VOID L_FAR* pUserData);
