...
#define ERROR_OCR_BADPLGN                                                                                                                  \
    -231 /* Bad Polygon used to define region extents; probably beyond the dimensions of the source image or bad vertices. */
...
#define ERROR_JP2_FAILURE -530
#define ERROR_JP2_SIGNATURE -531
#define ERROR_JP2_UNSUPPORTED -532
#define ERROR_J2K_FAILURE -533
#define ERROR_J2K_NO_SOC -534
#define ERROR_J2K_NO_SOT -535
#define ERROR_J2K_INFORMATION_SET -536
#define ERROR_J2K_LOW_TARGET_SIZE -537
#define ERROR_J2K_DECOMPOSITION_LEVEL -538
#define ERROR_J2K_MARKER_VALUE -539
#define ERROR_J2K_UNSUPPORTED -540
...
#define ERROR_PDF_FILE_ENCRYPTED                                                                                                           \
    -721 /* The Pdf file is encrypted and the szPassword 
...
#define ERROR_PDF_BAD_INITIALIZATION_FILES                                                                                                 \
    -729 /* Either the files required for initializing the PDF engine were 
