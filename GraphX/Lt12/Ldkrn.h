...
typedef enum { DOC_EVENT_GETPASSWORD = 500 } DOCUMENT_EVENT;
...
} DOCEDIT_SAVE_IMAGETYPE,
  *pDOCEDIT_SAVE_IMAGETYPE;
...
} DOC_SENDBYMAILFORMAT,
  *pDOC_SENDBYMAILFORMAT;
...
L_INT EXT_FUNCTION L_DocSendbyMail(pDOCHANDLE pDoc, L_UINT32* puStatusMode, pDOC_SENDBYMAILINFO pSendInfo, L_BOOL bUserInterface);
...
L_INT EXT_FUNCTION
L_DocDlgInsertRaster(HWND hWnd, pDOCHANDLE pDoc, pBITMAPHANDLE pBitmap, pDOCEDITINSERTOPTIONS pOptions, L_UINT32 dwFlags);
L_INT EXT_FUNCTION
L_DocDlgInsertVector(HWND hWnd, pDOCHANDLE pDoc, pVECTORHANDLE pVector, pDOCEDITINSERTOPTIONS pOptions, L_UINT32 dwFlags);
...
L_INT EXT_FUNCTION L_DocExBeginNewList(pDOCHANDLE pDoc, DOCUMENT_LISTTYPE ListType);
L_INT EXT_FUNCTION L_DocExEndList(pDOCHANDLE pDoc);
L_INT EXT_FUNCTION L_DocExBeginListItem(pDOCHANDLE pDoc);

L_INT EXT_FUNCTION L_DocExInsertHypertextLink(pDOCHANDLE pDoc, LPCSTR pszUrlName, LPCSTR pszLinkText, LPCSTR pszLinkImagePath);
...
L_INT EXT_FUNCTION L_DocExInsertQuotation(pDOCHANDLE pDoc, LPCSTR pszQuotationString);
...
L_INT EXT_FUNCTION L_DocExBeginInlineContainer(pDOCHANDLE pDoc,
                                               pHOBJECTSTYLE pInlineContainerStyle /* = NULL*/,
                                               LPCSTR pszClass /*=NULL */);
...
L_INT EXT_FUNCTION L_DocExGetUserPassword(pDOCHANDLE pDoc, L_CHAR* pszUserPassword);
...
L_INT EXT_FUNCTION
L_DocFTPConnect(pDOCHANDLE pDoc, L_UINT32* puStatusMode, L_CHAR* pszServer, L_INT iPort, L_CHAR* pszUserName, L_CHAR* pszPassword);

L_INT EXT_FUNCTION L_DocFTPDisconnect(pDOCHANDLE pDoc, L_UINT32* puStatusMode);

L_INT EXT_FUNCTION L_DocFTPChDir(pDOCHANDLE pDoc, L_UINT32* puStatusMode, L_CHAR* pszDirectory);

L_INT EXT_FUNCTION L_DocFTPSend(pDOCHANDLE pDoc, L_UINT32* puStatusMode, DOC_FTPUPLOADFORMAT Format, L_CHAR* pszRemote);
...
class DOCUMENT_EXPORT LDocEditor
{
  private:
    ...
    friend L_INT CALLBACK EnumImagesCallBack(pDOCHANDLE pDoc, pDOCEDIT_IMAGECALLBACKINFO pImageInfo);
    friend L_INT CALLBACK EnumVectorsCallBack(pDOCHANDLE pDoc, pDOCEDIT_VECTORCALLBACKINFO pVectorInfo);
  ...
  public:
    ...
    L_INT AddVectorDrawing(pVECTORHANDLE pVectorHandle,
                           L_INT nWidth,
                           L_INT nHeight,
                           DOCUMENT_OBJTEXTALIGN ObjAlign,
                           L_INT nHSpace,
    ...
    L_INT AddRasterImage(pBITMAPHANDLE pBitmap,
                         L_INT nWidth,
                         L_INT nHeight,
                         DOCUMENT_OBJTEXTALIGN ObjAlign,
                         L_INT nHSpace,
    ...
    /* mail support */
    L_INT SendbyMail(pDOC_SENDBYMAILINFO pSendInfo = NULL, L_BOOL bUserInterface = TRUE, L_UINT32* puStatusMode = NULL);
    /* Edit locking */
    ...
    L_INT AddRasterImageMemory(L_CHAR* pData,
                               ...
                               L_UINT32* puStatusMode         = NULL);
    /* Active X */
    L_INT InsertActiveX(pDOCEDIT_ACTIVEXINFO pActiveXInfo, pDOCEDIT_ACTIVEXPARAMS pParameters, L_UINT32* puStatusMode = NULL);
    /* Overwrite text */
    L_INT OverwriteText(L_BOOL bOverwrite = TRUE, L_UINT32* puStatusMode = NULL);

    /* End note */
    L_INT InsertEndnote(L_CHAR* pszNote, L_UINT32* puStatusMode = NULL);
    /* bookmarks */
    L_INT AddBookmark(L_CHAR* pBookmark, L_UINT32* puStatusMode = NULL);
    L_INT RemoveBookmark(L_UINT32* puStatusMode = NULL);
    L_INT GetBookmarks(pDOCBOOKMARKS pBookmarks, L_UINT32* puStatusMode = NULL);
    L_INT GotoBookmark(L_CHAR* pBookmark, L_UINT32* puStatusMode = NULL);
    ...
    L_INT StyleSetFontProperties(pHOBJECTSTYLE pObjStyle, pDOC_FONTPROPERTIES pFontProperties);
    L_INT StyleSetTextProperties(pHOBJECTSTYLE pObjStyle, pDOC_TEXTPROPERTIES pTextProperties);
    L_INT StyleSetBoxProperties(pHOBJECTSTYLE pObjStyle, pDOC_BOXPROPERTIES pBoxProperties);
    L_INT StyleSetBorderProperties(pHOBJECTSTYLE pObjStyle, pDOC_BORDERPROPERTIES pBorderProperties);
    L_INT StyleSetPositioningProperties(pHOBJECTSTYLE pObjStyle, pDOC_POSITIONINGPROPERTIES pPositioningProperties);
    L_INT StyleSetTextColor(pHOBJECTSTYLE pObjStyle, COLORREF crTextColor);
    L_INT StyleSetTextBackColor(pHOBJECTSTYLE pObjStyle, COLORREF crTextBgColor);
    L_INT StyleSetClass(pHOBJECTSTYLE pObjStyle, LPCSTR pszClass);
    L_INT StyleReset(pHOBJECTSTYLE pObjStyle);

    /* Exports from LDocHandle */
    L_INT ExBeginDocBody(pDOCPAGEMARGINS pDocPageMargins = NULL);
    L_INT ExInsertAsciiText(L_CHAR* pBuffer, L_UINT uSize);
    L_INT ExAddCharacter(L_CHAR cChar);
    L_INT ExInsertHtmlText(L_CHAR* pBuffer, L_UINT uSize);
    L_INT ExInsertTab();
    ...
    L_INT ExBeginTable(pDOC_TABLEPROPERTIES pTableProperties = NULL, pHOBJECTSTYLE pTableStyle = NULL, pHOBJECTSTYLE pCelleStyle = NULL);
    L_INT ExEndTable();
    L_INT ExBeginRow();
    ...
    L_INT ExInsertHypertextLink(LPCSTR pszUrlName, LPCSTR pszLinkText, LPCSTR pszLinkImagePath);
    ...
    L_INT ExBeginBlockContainer(pHOBJECTSTYLE pBlockContainerStyle = NULL, LPCSTR pszClass = NULL);
    L_INT ExEndBlockContainer();
    L_INT ExBeginInlineContainer(pHOBJECTSTYLE pInlineContainerStyle = NULL, LPCSTR pszClass = NULL);
    ...
    L_INT ExAddStyle(LPCSTR pszClass, pHOBJECTSTYLE pStyle);
    ...
    L_INT FTPConnect(L_CHAR* pszServer, L_INT iPort, L_CHAR* pszUserName, L_CHAR* pszPassword, L_UINT32* puStatusMode = NULL);

    L_INT FTPDisconnect(L_UINT32* puStatusMode = NULL);

    L_INT FTPChDir(L_CHAR* pszDirectory, L_UINT32* puStatusMode = NULL);

    L_INT FTPSend(DOC_FTPUPLOADFORMAT Format, L_CHAR* pszRemote, L_UINT32* puStatusMode = NULL);

    /* Image processing */
    L_INT GetImage(pBITMAPHANDLE phBitmap, L_UINT32* puStatusMode = NULL);

    L_INT SetImage(pBITMAPHANDLE phBitmap, L_UINT32* puStatusMode = NULL);
};
#endif //__cplusplus
