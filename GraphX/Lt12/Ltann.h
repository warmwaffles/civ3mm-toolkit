...
#define ISVALIDTOOL(nTool)                                                                                                                 \
    (((nTool) >= ANNTOOL_SELECT && (nTool) <= ANNTOOL_LAST) || ((nTool) >= ANNTOOL_USER && (nTool) <= ANNTOOL_USERLAST))
...
#define HANDLE_WM_LTANNEVENT(hwnd, wParam, lParam, fn) (LRESULT)(DWORD)(fn)(hwnd, (int)wParam, lParam)
#define FORWARD_WM_LTANNEVENT(hwnd, id, lParam, fn) (LRESULT)(DWORD)(fn)((hwnd), WM_LTANNEVENT, (int)(id), (LPARAM)(lParam))
...
L_INT EXT_FUNCTION L_AnnCopy(HANNOBJECT hSource, pHANNOBJECT phDest);

L_INT EXT_FUNCTION L_AnnCopyFromClipboard(HWND hWnd, pHANNOBJECT phContainer);

L_INT EXT_FUNCTION L_AnnCopyToClipboard(HANNOBJECT hObject, L_UINT uFormat, L_BOOL fSelected, L_BOOL fEmpty, L_BOOL fCheckMenu);

L_INT EXT_FUNCTION L_AnnCutToClipboard(HANNOBJECT hObject, L_UINT uFormat, L_BOOL fSelected, L_BOOL fEmpty, L_BOOL fCheckMenu);

L_INT EXT_FUNCTION L_AnnCreate(L_UINT uObjectType, pHANNOBJECT phObject);

L_INT EXT_FUNCTION L_AnnCreateContainer(HWND hWnd, pANNRECT pRect, L_BOOL fVisible, pHANNOBJECT phObject);
L_INT EXT_FUNCTION L_AnnCreateItem(HANNOBJECT hContainer, L_UINT uObjectType, L_BOOL fVisible, pHANNOBJECT phObject);
...
L_INT EXT_FUNCTION L_AnnDefine(HANNOBJECT hObject, LPPOINT pPoint, L_UINT uState);

L_INT EXT_FUNCTION L_AnnDestroy(HANNOBJECT hObject, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnDraw(HDC hDC, LPRECT prcInvalid, HANNOBJECT hObject);
L_INT EXT_FUNCTION
L_AnnEnumerate(HANNOBJECT hObject, ANNENUMCALLBACK pfnCallback, L_VOID L_FAR* pUserData, L_UINT uFlags, L_CHAR L_FAR* pUserList);
L_INT EXT_FUNCTION L_AnnFlip(HANNOBJECT hObject, pANNPOINT pCenter, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnGetActiveState(HANNOBJECT hObject, L_UINT L_FAR* puState);
L_INT EXT_FUNCTION L_AnnGetAutoContainer(HANNOBJECT hObject, pHANNOBJECT phContainer);
L_INT EXT_FUNCTION L_AnnGetAutoDrawEnable(HANNOBJECT hObject, L_BOOL L_FAR* pfEnable);

L_INT EXT_FUNCTION L_AnnGetAutoMenuEnable(HANNOBJECT hObject, L_BOOL L_FAR* pfEnable);

L_INT EXT_FUNCTION L_AnnGetAutoText(HANNOBJECT hObject, L_UINT uItem, L_CHAR L_FAR* pText);

L_INT EXT_FUNCTION L_AnnGetAutoTextLen(HANNOBJECT hObject, L_UINT uItem, L_UINT L_FAR* puLen);

L_INT EXT_FUNCTION L_AnnGetBackColor(HANNOBJECT hObject, COLORREF L_FAR* pcrBack);
L_INT EXT_FUNCTION L_AnnGetBitmap(HANNOBJECT hObject, pBITMAPHANDLE pBitmap);
L_INT EXT_FUNCTION L_AnnGetBitmapDpiX(HANNOBJECT hObject, L_DOUBLE L_FAR* pdDpiX);
L_INT EXT_FUNCTION L_AnnGetBitmapDpiY(HANNOBJECT hObject, L_DOUBLE L_FAR* pdDpiY);
L_INT EXT_FUNCTION L_AnnGetBoundingRect(HANNOBJECT hObject, LPRECT pRect);
L_INT EXT_FUNCTION L_AnnGetContainer(HANNOBJECT hObject, pHANNOBJECT phContainer);
L_INT EXT_FUNCTION L_AnnGetDistance(HANNOBJECT hObject, L_DOUBLE L_FAR* pdDistance, L_DOUBLE L_FAR* pdDistance2);
L_INT EXT_FUNCTION L_AnnGetDpiX(HANNOBJECT hObject, L_DOUBLE L_FAR* pdDpiX);
L_INT EXT_FUNCTION L_AnnGetDpiY(HANNOBJECT hObject, L_DOUBLE L_FAR* pdDpiY);
L_INT EXT_FUNCTION L_AnnGetFillMode(HANNOBJECT hObject, L_UINT L_FAR* puFillMode);
L_INT EXT_FUNCTION L_AnnGetFillPattern(HANNOBJECT hObject, L_UINT L_FAR* puFillPattern);
L_INT EXT_FUNCTION L_AnnGetFontBold(HANNOBJECT hObject, L_BOOL L_FAR* pfFontBold);
L_INT EXT_FUNCTION L_AnnGetFontItalic(HANNOBJECT hObject, L_BOOL L_FAR* pfFontItalic);
L_INT EXT_FUNCTION L_AnnGetFontName(HANNOBJECT hObject, L_CHAR L_FAR* pFontName);
L_INT EXT_FUNCTION L_AnnGetFontNameLen(HANNOBJECT hObject, L_UINT L_FAR* puLen);
L_INT EXT_FUNCTION L_AnnGetFontSize(HANNOBJECT hObject, L_DOUBLE L_FAR* pdFontSize);
L_INT EXT_FUNCTION L_AnnGetFontStrikeThrough(HANNOBJECT hObject, L_BOOL L_FAR* pfFontStrikeThrough);
L_INT EXT_FUNCTION L_AnnGetFontUnderline(HANNOBJECT hObject, L_BOOL L_FAR* pfFontUnderline);
L_INT EXT_FUNCTION L_AnnGetForeColor(HANNOBJECT hObject, COLORREF L_FAR* pcrFore);
L_INT EXT_FUNCTION L_AnnGetGaugeLength(HANNOBJECT hObject, L_DOUBLE L_FAR* pdLength);
L_INT EXT_FUNCTION
L_AnnGetHyperlink(HANNOBJECT hObject, L_UINT L_FAR* puType, L_UINT L_FAR* puMsg, WPARAM L_FAR* pwParam, L_CHAR L_FAR* pLink);
L_INT EXT_FUNCTION L_AnnGetHyperlinkLen(HANNOBJECT hObject, L_UINT L_FAR* puLen);
L_INT EXT_FUNCTION L_AnnGetHyperlinkMenuEnable(HANNOBJECT hObject, L_BOOL L_FAR* pfEnable);
L_INT EXT_FUNCTION L_AnnGetLineStyle(HANNOBJECT hObject, L_UINT L_FAR* puLineStyle);
L_INT EXT_FUNCTION L_AnnGetLineWidth(HANNOBJECT hObject, L_DOUBLE L_FAR* pdLineWidth);
L_INT EXT_FUNCTION L_AnnGetLocked(HANNOBJECT hObject, L_BOOL L_FAR* pfLocked);
L_INT EXT_FUNCTION L_AnnGetOffsetX(HANNOBJECT hObject, L_DOUBLE L_FAR* pdOffsetX);
L_INT EXT_FUNCTION L_AnnGetOffsetY(HANNOBJECT hObject, L_DOUBLE L_FAR* pdOffsetY);
L_INT EXT_FUNCTION L_AnnGetPointCount(HANNOBJECT hObject, L_UINT L_FAR* puCount);
L_INT EXT_FUNCTION L_AnnGetPoints(HANNOBJECT hObject, pANNPOINT pPoints);
L_INT EXT_FUNCTION L_AnnGetPolyFillMode(HANNOBJECT hObject, L_UINT L_FAR* puPolyFillMode);
L_INT EXT_FUNCTION L_AnnGetRect(HANNOBJECT hObject, pANNRECT pRect);
L_INT EXT_FUNCTION L_AnnGetROP2(HANNOBJECT hObject, L_UINT L_FAR* puRop2);
L_INT EXT_FUNCTION L_AnnGetScalarX(HANNOBJECT hObject, L_DOUBLE L_FAR* pdScalarX);
L_INT EXT_FUNCTION L_AnnGetScalarY(HANNOBJECT hObject, L_DOUBLE L_FAR* pdScalarY);
L_INT EXT_FUNCTION L_AnnGetSelectCount(HANNOBJECT hObject, L_UINT L_FAR* puCount);
L_INT EXT_FUNCTION L_AnnGetSelected(HANNOBJECT hObject, L_BOOL L_FAR* pfSelected);
L_INT EXT_FUNCTION L_AnnGetSelectItems(HANNOBJECT hObject, pHANNOBJECT pItems);
L_INT EXT_FUNCTION L_AnnGetSelectRect(HANNOBJECT hObject, LPRECT pRect);
L_INT EXT_FUNCTION L_AnnGetTag(HANNOBJECT hObject, L_UINT32 L_FAR* puTag);
L_INT EXT_FUNCTION L_AnnGetText(HANNOBJECT hObject, L_CHAR L_FAR* pText);
L_INT EXT_FUNCTION L_AnnGetTextLen(HANNOBJECT hObject, L_UINT L_FAR* puLen);
L_INT EXT_FUNCTION L_AnnGetTool(HANNOBJECT hObject, L_UINT L_FAR* puTool);
L_INT EXT_FUNCTION L_AnnGetToolBarButtonVisible(HWND hwndToolBar, L_UINT uButton, L_BOOL L_FAR* pfVisible);
L_INT EXT_FUNCTION L_AnnGetToolBarChecked(HWND hwndToolBar, L_UINT L_FAR* puChecked);
L_INT EXT_FUNCTION L_AnnGetTransparent(HANNOBJECT hObject, L_BOOL L_FAR* pbTransparent);
L_INT EXT_FUNCTION L_AnnGetType(HANNOBJECT hObject, L_UINT L_FAR* puObjectType);
L_INT EXT_FUNCTION L_AnnGetTopContainer(HANNOBJECT hObject, pHANNOBJECT phContainer);
L_INT EXT_FUNCTION L_AnnGetUnit(HANNOBJECT hObject, L_UINT L_FAR* puUnit, L_CHAR L_FAR* pUnitAbbrev, L_UINT L_FAR* puPrecision);
L_INT EXT_FUNCTION L_AnnGetUnitLen(HANNOBJECT hObject, L_UINT L_FAR* puLen);
L_INT EXT_FUNCTION L_AnnGetUserMode(HANNOBJECT hObject, L_UINT L_FAR* puMode);
L_INT EXT_FUNCTION L_AnnGetVisible(HANNOBJECT hObject, L_BOOL L_FAR* pfVisible);
L_INT EXT_FUNCTION L_AnnGetWnd(HANNOBJECT hObject, HWND L_FAR* phWnd);
L_INT EXT_FUNCTION L_AnnHitTest(HANNOBJECT hObject, LPPOINT pPoint, L_UINT L_FAR* puResult, pHANNOBJECT phObjectHit);
L_INT EXT_FUNCTION L_AnnInsert(HANNOBJECT hContainer, HANNOBJECT hObject, L_BOOL fStripContainer);
L_INT EXT_FUNCTION L_AnnGetItem(HANNOBJECT hContainer, pHANNOBJECT phItem);
L_INT EXT_FUNCTION L_AnnLoad(L_CHAR L_FAR* pFile, pHANNOBJECT phObject, pLOADFILEOPTION pLoadOptions);
L_INT EXT_FUNCTION L_AnnLoadOffset(L_INT fd, L_INT32 nOffset, L_UINT32 nLength, pHANNOBJECT phObject, pLOADFILEOPTION pLoadOptions);
L_INT EXT_FUNCTION L_AnnLoadMemory(L_UCHAR L_FAR* pMem, L_UINT32 uMemSize, pHANNOBJECT phObject, pLOADFILEOPTION pLoadOptions);
L_INT EXT_FUNCTION L_AnnLock(HANNOBJECT hObject, L_CHAR L_FAR* pLockKey, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnMove(HANNOBJECT hObject, L_DOUBLE dDx, L_DOUBLE dDy, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnPrint(HDC hDC, LPRECT prcBounds, HANNOBJECT hObject);
L_INT EXT_FUNCTION L_AnnRealize(pBITMAPHANDLE pBitmap, LPRECT prcBounds, HANNOBJECT hObject, L_BOOL fRedactOnly);
L_INT EXT_FUNCTION L_AnnResize(HANNOBJECT hObject, L_DOUBLE dFactorX, L_DOUBLE dFactorY, pANNPOINT pCenter, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnReverse(HANNOBJECT hObject, pANNPOINT pCenter, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnRemove(HANNOBJECT hObject);
L_INT EXT_FUNCTION L_AnnRotate(HANNOBJECT hObject, L_DOUBLE dAngle, pANNPOINT pCenter, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSave(L_CHAR L_FAR* pFile, HANNOBJECT hObject, L_UINT uFormat, L_BOOL fSelected);
L_INT EXT_FUNCTION
L_AnnSaveOffset(L_INT fd, L_INT32 nOffset, L_UINT32 L_FAR* puSizeWritten, HANNOBJECT hObject, L_UINT uFormat, L_BOOL fSelected);
L_INT EXT_FUNCTION L_AnnSaveMemory(HANNOBJECT hObject, L_UINT uFormat, L_BOOL fSelected, HGLOBAL L_FAR* phMem, L_UINT32 L_FAR* puMemSize);
L_INT EXT_FUNCTION L_AnnSaveTag(HANNOBJECT hObject, L_UINT uFormat, L_BOOL fSelected);
L_INT EXT_FUNCTION L_AnnSelectPoint(HANNOBJECT hObject, LPPOINT pPoint);
L_INT EXT_FUNCTION L_AnnSelectRect(HANNOBJECT hObject, LPRECT pRect);
L_INT EXT_FUNCTION L_AnnSendToBack(HANNOBJECT hObject);

L_INT EXT_FUNCTION L_AnnSetActiveState(HANNOBJECT hObject, L_UINT uState);
L_INT EXT_FUNCTION L_AnnSetAutoContainer(HANNOBJECT hObject, HANNOBJECT hContainer);
L_INT EXT_FUNCTION L_AnnSetAutoDrawEnable(HANNOBJECT hObject, L_BOOL fEnable);
L_INT EXT_FUNCTION L_AnnSetAutoMenuEnable(HANNOBJECT hObject, L_BOOL fEnable);
L_INT EXT_FUNCTION L_AnnSetAutoText(HANNOBJECT hObject, L_UINT uItem, L_CHAR L_FAR* pText);
L_INT EXT_FUNCTION L_AnnSetBackColor(HANNOBJECT hObject, COLORREF crBack, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetBitmap(HANNOBJECT hObject, pBITMAPHANDLE pBitmap, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetBitmapDpiX(HANNOBJECT hObject, L_DOUBLE dDpiX, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetBitmapDpiY(HANNOBJECT hObject, L_DOUBLE dDpiY, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetDpiX(HANNOBJECT hObject, L_DOUBLE dDpiX, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetDpiY(HANNOBJECT hObject, L_DOUBLE dDpiY, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetFillMode(HANNOBJECT hObject, L_UINT uFillMode, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetFillPattern(HANNOBJECT hObject, L_UINT uFillPattern, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetFontBold(HANNOBJECT hObject, L_BOOL fFontBold, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetFontItalic(HANNOBJECT hObject, L_BOOL fFontItalic, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetFontName(HANNOBJECT hObject, L_CHAR L_FAR* pFontName, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetFontSize(HANNOBJECT hObject, L_DOUBLE dFontSize, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetFontStrikeThrough(HANNOBJECT hObject, L_BOOL fFontStrikeThrough, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetFontUnderline(HANNOBJECT hObject, L_BOOL fFontUnderline, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetForeColor(HANNOBJECT hObject, COLORREF crFore, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetGaugeLength(HANNOBJECT hObject, L_DOUBLE dLength, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetHyperlink(HANNOBJECT hObject, L_UINT uType, L_UINT uMsg, WPARAM wParam, L_CHAR L_FAR* pLink, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetHyperlinkMenuEnable(HANNOBJECT hObject, L_BOOL fEnable, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetLineStyle(HANNOBJECT hObject, L_UINT uLineStyle, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetLineWidth(HANNOBJECT hObject, L_DOUBLE dLineWidth, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetOffsetX(HANNOBJECT hObject, L_DOUBLE dOffsetX, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetOffsetY(HANNOBJECT hObject, L_DOUBLE dOffsetY, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetPoints(HANNOBJECT hObject, pANNPOINT pPoints, L_UINT uCount);
L_INT EXT_FUNCTION L_AnnSetPolyFillMode(HANNOBJECT hObject, L_UINT uPolyFillMode, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetROP2(HANNOBJECT hObject, L_UINT uROP2, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetRect(HANNOBJECT hObject, pANNRECT pRect);
L_INT EXT_FUNCTION L_AnnSetSelected(HANNOBJECT hObject, L_BOOL fSelected, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetScalarX(HANNOBJECT hObject, L_DOUBLE dScalarX, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetScalarY(HANNOBJECT hObject, L_DOUBLE dScalarY, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetTag(HANNOBJECT hObject, L_UINT32 uTag, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetText(HANNOBJECT hObject, L_CHAR L_FAR* pText, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetTool(HANNOBJECT hObject, L_UINT uTool);
L_INT EXT_FUNCTION L_AnnSetToolBarButtonVisible(HWND hwndToolBar, L_UINT uButton, L_BOOL fVisible);
L_INT EXT_FUNCTION L_AnnSetToolBarChecked(HWND hwndToolBar, L_UINT uChecked);
L_INT EXT_FUNCTION L_AnnSetTransparent(HANNOBJECT hObject, L_BOOL bTransparent, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetUndoDepth(HANNOBJECT hObject, L_UINT uLevels);
L_INT EXT_FUNCTION L_AnnSetUnit(HANNOBJECT hObject, L_UINT uUnit, L_CHAR L_FAR* pUnitAbbrev, L_UINT uPrecision, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnSetUserMode(HANNOBJECT hObject, L_UINT uMode);
L_INT EXT_FUNCTION L_AnnSetVisible(HANNOBJECT hObject, L_BOOL fVisible, L_UINT uFlags, L_CHAR L_FAR* pUserList);
L_INT EXT_FUNCTION L_AnnSetWnd(HANNOBJECT hObject, HWND hWnd);
L_INT EXT_FUNCTION L_AnnShowLockedIcon(HANNOBJECT hObject, L_BOOL bShow, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnUndo(HANNOBJECT hObject);
L_INT EXT_FUNCTION L_AnnUnlock(HANNOBJECT hObject, L_CHAR L_FAR* pUnlockKey, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnUnrealize(pBITMAPHANDLE pBitmap, LPRECT prcBounds, HANNOBJECT hObject, L_BOOL fSelected);

L_INT EXT_FUNCTION L_AnnSetNodes(HANNOBJECT hObject, L_BOOL bShowNodes, L_UINT uGapNodes, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnGetNodes(HANNOBJECT hObject, L_BOOL L_FAR* pbShowNodes, L_UINT L_FAR* puGapNodes);
...
L_INT EXT_FUNCTION L_AnnSetName(HANNOBJECT hObject, L_BOOL bShowName, L_CHAR L_FAR* pText, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnGetName(HANNOBJECT hObject, L_BOOL L_FAR* pbShowName, L_UINT L_FAR* puNameLen, L_CHAR L_FAR* pName);
L_INT EXT_FUNCTION L_AnnSetShowFlags(HANNOBJECT hObject, L_UINT uShowFlags, L_UINT uFlags);
L_INT EXT_FUNCTION L_AnnGetShowFlags(HANNOBJECT hObject, L_UINT L_FAR* puShowFlags);

L_INT EXT_FUNCTION L_AnnGetAngle(HANNOBJECT hObject, L_DOUBLE L_FAR* pdAngle);

/* newest functions */

L_INT EXT_FUNCTION L_AnnSetMetafile(HANNOBJECT hObject, HMETAFILE hMetafile, L_UINT uType, L_UINT uFlags);

L_INT EXT_FUNCTION L_AnnGetMetafile(HANNOBJECT hObject, HMETAFILE L_FAR* phMetafile);

L_INT EXT_FUNCTION L_AnnSetPredefinedMetafile(L_UINT uType, HMETAFILE hMetafile);

L_INT EXT_FUNCTION L_AnnGetPredefinedMetafile(L_UINT uType, HMETAFILE L_FAR* phMetafile, L_BOOL L_FAR* pbEnhanced);

L_INT EXT_FUNCTION L_AnnSetSecondaryBitmap(HANNOBJECT hObject, pBITMAPHANDLE pBitmap, L_UINT uFlags);

L_INT EXT_FUNCTION L_AnnGetSecondaryBitmap(HANNOBJECT hObject, pBITMAPHANDLE pBitmap);

L_INT EXT_FUNCTION
L_AnnSetAutoMenuItemEnable(HANNOBJECT hObject, L_INT nObjectType, L_UINT uItem, L_UINT uEnable, L_UINT uFlags, L_CHAR L_FAR* pUserList);

L_INT EXT_FUNCTION L_AnnGetAutoMenuItemEnable(HANNOBJECT hObject, L_INT nObjectType, L_UINT uItem, L_UINT L_FAR* puEnable);
...
L_INT EXT_FUNCTION
L_AnnGetAutoMenuState(HANNOBJECT hObject, L_INT nObjectType, L_UCHAR L_FAR* pEnable, L_UCHAR L_FAR* pEnableFlags, L_UINT uBits);

L_INT EXT_FUNCTION L_AnnSetUser(HANNOBJECT hObject, L_CHAR L_FAR* pOldUser, L_CHAR L_FAR* pNewUser, L_UINT uFlags);

L_INT EXT_FUNCTION L_AnnSetToolBarButtons(HWND hwndToolBar, pANNBUTTON pButtons, L_UINT uButtons);

L_INT EXT_FUNCTION L_AnnGetToolBarButtons(HWND hwndToolBar, pANNBUTTON pButtons, L_UINT L_FAR* puButtons);

L_INT EXT_FUNCTION L_AnnFreeToolBarButtons(pANNBUTTON pButtons, L_UINT uButtons);

L_INT EXT_FUNCTION L_AnnGetToolBarInfo(HWND hwndToolBar, pANNTOOLBARINFO pInfo);

L_INT EXT_FUNCTION L_AnnSetToolBarColumns(HWND hwndToolBar, L_UINT uColumns);

L_INT EXT_FUNCTION L_AnnSetToolBarRows(HWND hwndToolBar, L_UINT uColumns);

L_INT EXT_FUNCTION L_AnnSetAutoDefaults(HANNOBJECT hAutomation, HANNOBJECT hObject, L_UINT uFlags);

L_INT EXT_FUNCTION L_AnnSetTransparentColor(HANNOBJECT hObject, COLORREF crTransparent, L_UINT uFlags);

L_INT EXT_FUNCTION L_AnnGetTransparentColor(HANNOBJECT hObject, COLORREF L_FAR* pcrTransparent);

L_INT EXT_FUNCTION L_AnnGetUndoDepth(HANNOBJECT hObject, L_UINT L_FAR* puUsedLevels, L_UINT L_FAR* puMaxLevels);

L_INT EXT_FUNCTION L_AnnGroup(HANNOBJECT hObject, L_UINT uFlags, L_CHAR L_FAR* pUserList);

L_INT EXT_FUNCTION L_AnnUngroup(HANNOBJECT hObject, L_UINT uFlags, L_CHAR L_FAR* pUserList);

#ifdef WIN32
L_INT EXT_FUNCTION L_AnnSetAutoOptions(HANNOBJECT hObject, L_UINT uFlags);

L_INT EXT_FUNCTION L_AnnGetAutoOptions(HANNOBJECT hObject, L_UINT L_FAR* puFlags);
#endif

L_INT EXT_FUNCTION L_AnnGetObjectFromTag(HANNOBJECT hContainer, L_UINT uFlags, L_UINT32 uTag, pHANNOBJECT phTagObject);

L_INT EXT_FUNCTION L_AnnGetRgnHandle(HANNOBJECT hObject, pRGNXFORM pXForm, HRGN L_FAR* phRgn);

L_INT EXT_FUNCTION L_AnnGetArea(HANNOBJECT hObject, L_UINT32 L_FAR* puCount);

L_INT EXT_FUNCTION L_AnnSetAutoDialogFontSize(HANNOBJECT hObject, L_INT nFontSize);

L_INT EXT_FUNCTION L_AnnGetAutoDialogFontSize(HANNOBJECT hObject, L_INT L_FAR* pnFontSize);

L_INT EXT_FUNCTION L_AnnSetGrouping(HANNOBJECT hObject, L_BOOL bAutoGroup, L_UINT uFlags);

L_INT EXT_FUNCTION L_AnnGetGrouping(HANNOBJECT hObject, L_BOOL L_FAR* pbAutoGroup);

L_INT EXT_FUNCTION L_AnnSetAutoBackColor(HANNOBJECT hObject, L_UINT uObjectType, COLORREF crBack);

L_INT EXT_FUNCTION L_AnnGetAutoBackColor(HANNOBJECT hObject, L_UINT uObjectType, COLORREF L_FAR* pcrBack);

L_INT EXT_FUNCTION L_AnnAddUndoNode(HANNOBJECT hObject);

L_INT EXT_FUNCTION L_AnnSetAutoUndoEnable(HANNOBJECT hObject, L_BOOL bEnable);

L_INT EXT_FUNCTION L_AnnGetAutoUndoEnable(HANNOBJECT hObject, L_BOOL L_FAR* pbEnable);
