...
#define L_BS_THUMBTRACK                                                                                                                    \
    0x00000004                       /* Track the thumb position when using
                                          scroll bars */
...
#define L_BS_BKGNDPALETTE                                                                                                                  \
    0x00000040 /* Palette should be forced to the
                                          background */
#define L_BS_NOPOSTQUIT                                                                                                                    \
    0x00000080                   /* WM_QUIT message should not be
