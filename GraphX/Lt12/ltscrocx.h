typedef enum { SCR_CAP_ALL = 0, SCR_CAP_BITMAP = 1, SCR_CAP_ICON = 2, SCR_CAP_CURSOR = 4 } ScreenCaptureResourceTypes;

typedef enum { SCR_CAP_EXEDLG_TABVIEW = 0, SCR_CAP_EXEDLG_TREEVIEW } ScreenCaptureExeDlgTypes;
