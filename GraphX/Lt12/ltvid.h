...
typedef L_INT(pEXT_CALLBACK VIDRENDERCALLBACK)(pBITMAPHANDLE pBitmap, L_UINT nFrame, L_VOID L_FAR* pUserData);

typedef L_INT(pEXT_CALLBACK ENUMCOMPCALLBACK)(L_CHAR L_FAR* szName, L_VOID L_FAR* pUserData);

typedef L_INT(pEXT_CALLBACK ENUMDRIVERCALLBACK)(L_INT iIndex, L_CHAR L_FAR* szName, L_CHAR L_FAR* szVersion, L_VOID L_FAR* pUserData);

typedef L_VOID(pEXT_CALLBACK MMEVENTCALLBACK)(pMEDIAHANDLE pMMedia, L_INT nEvent, L_VOID L_FAR* pUserData);
...
L_INT EXT_FUNCTION L_MMLoad(L_CHAR L_FAR* pszFile, pMEDIAHANDLE pMMedia, L_INT nOpen);

L_INT EXT_FUNCTION L_MMFree(pMEDIAHANDLE pMMedia);

L_INT EXT_FUNCTION L_MMPlay(pMEDIAHANDLE pMMedia, L_CHAR L_FAR* pszCaption);

L_INT EXT_FUNCTION L_MMSetRate(pMEDIAHANDLE pMMedia, L_DOUBLE dRate);

L_INT EXT_FUNCTION L_MMGetRate(pMEDIAHANDLE pMMedia, L_DOUBLE L_FAR* pdRate);

L_INT EXT_FUNCTION L_MMStop(pMEDIAHANDLE pMMedia);

L_INT EXT_FUNCTION L_MMPause(pMEDIAHANDLE pMMedia);

L_INT EXT_FUNCTION L_MMMarkClip(pMEDIAHANDLE pMMedia, L_INT32 dwStart, L_INT32 dwStop);

L_INT EXT_FUNCTION L_MMSetVolume(pMEDIAHANDLE pMMedia, L_INT nVolume);

L_INT EXT_FUNCTION L_MMGetVolume(pMEDIAHANDLE pMMedia, L_INT L_FAR* pnVolume);

L_INT EXT_FUNCTION L_MMSetBalance(pMEDIAHANDLE pMMedia, L_INT nBalance);

L_INT EXT_FUNCTION L_MMGetBalance(pMEDIAHANDLE pMMedia, L_INT L_FAR* pnBalance);

L_INT EXT_FUNCTION L_MMSetSrcRect(pMEDIAHANDLE pMMedia, L_INT nXpos, L_INT nYpos, L_INT nWidth, L_INT nHeight);

L_INT EXT_FUNCTION L_MMSetDstRect(pMEDIAHANDLE pMMedia, L_INT nXpos, L_INT nYpos, L_INT nWidth, L_INT nHeight);

L_INT EXT_FUNCTION
L_MMSetPlayExt(pMEDIAHANDLE pMMedia, HWND hwndParent, L_INT nXpos, L_INT nYpos, L_INT nWidth, L_INT nHeight, L_UINT32 dwStyle);

L_INT EXT_FUNCTION L_MMLoadMemory(L_CHAR L_FAR* pBuffer, pMEDIAHANDLE pMMedia, L_INT32 dwBufferSize);
...
L_INT EXT_FUNCTION L_MMEnumAudioCompressors(pMEDIAHANDLE pMMedia, ENUMCOMPCALLBACK pCallback, L_VOID L_FAR* pUserData);
...
L_INT EXT_FUNCTION L_MMEnumVideoCompressors(pMEDIAHANDLE pMMedia, ENUMCOMPCALLBACK pCallback, L_VOID L_FAR* pUserData);

L_INT EXT_FUNCTION L_MMGetBitmap(pMEDIAHANDLE pMMedia, pBITMAPHANDLE pBitmap, L_INT32 lPos);

L_INT EXT_FUNCTION L_MMSetTimeFormat(pMEDIAHANDLE pMMedia, L_INT nFormat);

L_INT EXT_FUNCTION L_MMGetTimeFormat(pMEDIAHANDLE pMMedia, L_INT L_FAR* pnFormat);

L_INT EXT_FUNCTION
L_MMConvertTime(pMEDIAHANDLE pMMedia, L_INT32 L_FAR* pdwTarget, L_INT nTargetFormat, L_INT32 dwSource, L_INT nSourceFormat);

L_INT EXT_FUNCTION L_MMResume(pMEDIAHANDLE pMMedia);

L_INT EXT_FUNCTION L_MMStartRecord(L_CHAR L_FAR* pszFile, pMEDIAHANDLE pMMedia, L_INT nDevice, L_INT nFormat);
...
L_INT EXT_FUNCTION L_MMAdjustWin(pMEDIAHANDLE pMMedia, L_INT nXpos, L_INT nYpos, L_INT nWidth, L_INT nHeight);

L_INT EXT_FUNCTION L_MMSetParentWin(pMEDIAHANDLE pMMedia, HWND hwndOwner);

L_INT EXT_FUNCTION L_MMSetMessageWin(pMEDIAHANDLE pMMedia, HWND hwndMessage);

L_INT EXT_FUNCTION L_MMSetEventCallback(MMEVENTCALLBACK pCallback, L_VOID L_FAR* pUserData);

L_INT EXT_FUNCTION L_MMGetCurrentPos(pMEDIAHANDLE pMMedia, L_INT32 L_FAR* plPos);

L_INT EXT_FUNCTION L_MMSetCurrentPos(pMEDIAHANDLE pMMedia, L_INT32 lPos);

L_INT EXT_FUNCTION L_MMSetWinVisible(pMEDIAHANDLE pMMedia, L_BOOL bVisibility);

L_INT EXT_FUNCTION L_MMReplaceFrame(pMEDIAHANDLE pMMedia, L_INT32 lFrame, pBITMAPHANDLE pBitmap);

L_INT EXT_FUNCTION L_MMInsertFrame(pMEDIAHANDLE pMMedia, L_INT32 lFrame, pBITMAPHANDLE pBitmap);

L_INT EXT_FUNCTION L_MMDeleteFrames(pMEDIAHANDLE pMMedia, L_INT32 lStart, L_INT32 lLength, L_UINT32 uFlags);

L_INT EXT_FUNCTION L_MMCopyFrames(pMEDIAHANDLE pMMedia, L_INT32 lStart, L_INT32 lLength, L_UINT32 uFlags);

L_INT EXT_FUNCTION L_MMPasteFrames(pMEDIAHANDLE pMMedia, L_INT32 lStart, L_INT32 lLength, L_UINT32 uFlags);

L_INT EXT_FUNCTION L_MMSetActive(pMEDIAHANDLE pMMedia, L_INT nActive);

L_INT EXT_FUNCTION
L_MMAddStream(pMEDIAHANDLE pMMedia, L_UINT uType, L_VOID* pFormat, L_CHAR L_FAR* pszVidComp, L_INT nFPerSec, pCOMPRESSIONOPTS pCompOpts);

L_INT EXT_FUNCTION L_MMGetStreamType(pMEDIAHANDLE pMMedia, L_INT nStream, L_UINT* puType);
...
L_INT EXT_FUNCTION L_MMDeleteStream(pMEDIAHANDLE pMMedia, L_INT nStream);

L_BOOL EXT_FUNCTION L_MMIsPlaying(pMEDIAHANDLE pMMedia);

L_BOOL EXT_FUNCTION L_MMIsOptionAvailable(L_CHAR L_FAR* pszName, L_INT nType, L_INT nOption);

L_INT EXT_FUNCTION L_MMDisplayDlg(HWND hWnd, L_CHAR L_FAR* pszName, L_INT nType, L_INT nDlgType);

L_INT EXT_FUNCTION L_MMAddSoundFile(L_CHAR L_FAR* pszFile, pMEDIAHANDLE pMMedia, L_INT32 lSrcPos, L_INT32 lDstPos, L_INT32 lLength);

L_INT EXT_FUNCTION L_MMShowRendererProperties(pMEDIAHANDLE pMMedia, HWND hwndParent);

L_INT EXT_FUNCTION L_MMGetRendererFlags(pMEDIAHANDLE pMMedia, L_UINT32 L_FAR* pFlags);

L_INT EXT_FUNCTION L_MMSetRendererFlags(pMEDIAHANDLE pMMedia, L_UINT32 ulFlags);
