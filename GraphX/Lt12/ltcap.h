/*[]=====================================================================[]*/
/*[]     GRAPHX CAPTURE DLL - Video Capture Support                   []*/
/*[]                                                                     []*/
...
typedef L_INT(pEXT_CALLBACK CAPVIDCALLBACK)(LPVIDEODATA pVidData, L_VOID L_FAR* pUserData);

typedef L_INT(pEXT_CALLBACK CAPAUDCALLBACK)(LPWAVEDATA pAudData, L_VOID L_FAR* pUserData);
...
typedef L_INT(pEXT_CALLBACK CAPSTATCALLBACK)(L_CHAR L_FAR* lpszString, L_VOID L_FAR* pUserData);

typedef L_INT(pEXT_CALLBACK FEEDSOUNDCALLBACK)(HGLOBAL hSound, L_UINT uMsg, L_VOID L_FAR* pUserData);

typedef L_VOID(pEXT_CALLBACK ENUMMIXERLINESCALLBACK)(pMIXERLINEINFO pInfo, L_VOID L_FAR* pUserData);
...
HWND EXT_FUNCTION
L_CapCreateWin(L_CHAR L_FAR* szTitle, L_UINT32 uStyle, L_INT nXpos, L_INT nYpos, L_INT nWidth, L_INT nHeight, HWND hwndParent);

L_INT EXT_FUNCTION L_CapConnect(HWND hwndCap, L_INT nDriver);

L_INT EXT_FUNCTION L_CapDisconnect(HWND hwndCap);

L_INT EXT_FUNCTION L_CapSetWorkFile(HWND hwndCap, L_CHAR L_FAR* pszCapFile, L_UINT32 uSize);

L_INT EXT_FUNCTION L_CapCopyFileAs(HWND hwndCap, L_CHAR L_FAR* pszFilename);

L_INT EXT_FUNCTION
L_CapSaveFrame(HWND hwndCap, L_CHAR L_FAR* pszCapFile, L_INT nFormat, L_INT nBitsPerPixel, L_INT nQFactor, L_BOOL bMultipage);

L_INT EXT_FUNCTION L_CapSetOverlay(HWND hwndCap, L_BOOL bOverlay);

L_INT EXT_FUNCTION L_CapSetVidOffset(HWND hwndCap, L_INT nXpos, L_INT nYpos);

L_INT EXT_FUNCTION L_CapCopyToClipboard(HWND hwndCap);

L_INT EXT_FUNCTION L_CapSetOptions(HWND hwndCap, pCAPTUREOPTIONS pOptions);

L_INT EXT_FUNCTION L_CapGetOptions(HWND hwndCap, pCAPTUREOPTIONS pOptions);

L_INT EXT_FUNCTION L_CapGetStatus(HWND hwndCap, pCAPSTATUSINFO pCapInfo);

L_INT EXT_FUNCTION L_CapSetPreview(HWND hwndCap, L_BOOL bPreview, L_FLOAT uRate, L_BOOL bStretch);

L_INT EXT_FUNCTION L_CapStopCapture(HWND hwndCap);

L_INT EXT_FUNCTION L_CapDisplayDlg(HWND hwndCap, L_UINT uType);

L_INT EXT_FUNCTION L_CapSetVidFormat(HWND hwndCap, BITMAPINFO L_FAR* pInfo, L_UINT uSize);

L_INT EXT_FUNCTION L_CapGetVidFormat(HWND hwndCap, BITMAPINFO L_FAR* pInfo, L_UINT L_FAR* puSize);

L_INT EXT_FUNCTION L_CapSetAudFormat(HWND hwndCap, LPWAVEFORMATDATA pWaveFormat, L_UINT uSize);

L_INT EXT_FUNCTION L_CapGetAudFormat(HWND hwndCap, LPWAVEFORMATDATA pWaveFormat, L_UINT L_FAR* puSize);

L_INT EXT_FUNCTION L_CapStartCapture(HWND hwndCap);

L_INT EXT_FUNCTION L_CapEnumDrivers(ENUMDRIVERCALLBACK pfnCallback, L_VOID L_FAR* pUserData);

L_BOOL EXT_FUNCTION L_CapIsOptionAvailable(HWND hwndCap, L_UINT uOption);
...
L_INT EXT_FUNCTION L_CapSetStatusCB(HWND hwndCap, CAPSTATCALLBACK pfnCallback, L_VOID L_FAR* pUserData);

L_INT EXT_FUNCTION
L_CapSetMMCallbacks(HWND hwndCap, CAPVIDCALLBACK pVidCB, L_VOID L_FAR* pVidData, CAPAUDCALLBACK pAudCB, L_VOID L_FAR* pAudData);
...
L_INT EXT_FUNCTION L_CapStopFeedSound(HGLOBAL hSound, L_BOOL bStopWhenReady);

L_INT EXT_FUNCTION L_CapFeedSound(HGLOBAL hSound, LPWAVEDATA lpWaveData);

L_INT EXT_FUNCTION L_CapFeedResetSound(HGLOBAL hSound);

L_INT EXT_FUNCTION L_CapPauseFeedSound(HGLOBAL hSound, L_BOOL bPause);

L_INT EXT_FUNCTION L_CapGetIDFromAud(LPWAVEFORMATDATA pWaveFormat, L_UINT L_FAR* puID);

L_INT EXT_FUNCTION L_CapGetAudFromID(LPWAVEFORMATDATA pWaveFormat, L_UINT uID);
...
L_INT EXT_FUNCTION L_CapGetMetrics(L_UINT uMetric, L_VOID L_FAR* pMetric);
