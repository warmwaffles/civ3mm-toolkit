...
L_INT EXT_FUNCTION L_VecDlgRender( HWND hWnd, pVECTORHANDLE pVector, L_BOOL L_FAR *pbUseLights, COLORREF L_FAR *pColorAmbient, L_INT L_FAR *pnPolygonMode, L_UINT32 dwFlags );
...
L_INT EXT_FUNCTION L_VecDlgNewLayer( HWND hWnd, pVECTORHANDLE pVector, pVECTORLAYERDESC pLayerDesc, pVECTORLAYER pLayer, L_BOOL L_FAR *pbActiveLayer, L_UINT32 dwFlags );
L_INT EXT_FUNCTION L_VecDlgEditLayer( HWND hWnd, pVECTORHANDLE pVector, pVECTORLAYER pLayer, pVECTORLAYERDESC pLayerDesc, L_BOOL L_FAR *pbActiveLayer, L_UINT32 dwFlags );
...
L_INT EXT_FUNCTION L_VecDlgNewObject( HWND hWnd, pVECTORHANDLE pVector, const pVECTORLAYER pLayer, L_INT nType, L_VOID L_FAR *pObjectDesc, pVECTOROBJECT, L_UINT32 dwFlags );
L_INT EXT_FUNCTION L_VecDlgEditObject( HWND hWnd, pVECTORHANDLE pVector, const pVECTOROBJECT pObject, L_INT nType, L_VOID L_FAR *pObjectDesc, L_UINT32 dwFlags );
L_INT EXT_FUNCTION L_VecDlgObjectAttributes( HWND hWnd, pVECTORHANDLE pVector, const pVECTOROBJECT pObject, L_BOOL *pbSelected, L_INT *pnROP, pVECTORPEN pPen, pVECTORBRUSH pBrush, pVECTORFONT pFont, L_UINT32 dwFlags );
