...
const int CodeMask[13] = { 0, 0x0001, 0x0003, 0x0007, 0x000F, 0x001F, 0x003F, 0x007F, 0x00FF, 0x01FF, 0x03FF, 0x07FF, 0x0FFF };
...
class CGifCoder : public CObject
{
  ...
  public:
    L_INT LoadMemory(L_CHAR L_FAR* pBuffer,
                     ...
                     pFILEINFO pFileInfo);
    L_INT LoadBitmapMemory(L_CHAR L_FAR* pBuffer,
                           pBITMAPHANDLE pBitmap,
                           L_INT nBitsPerPixel,
                           L_INT nOrder,
                           L_INT32 nBufferSize,
