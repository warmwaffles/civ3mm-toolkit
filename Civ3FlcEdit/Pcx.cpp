...
BOOL CPcx::LoadBgdImgFile(LPCTSTR lpszPathName)
{
...
int CPcx::DecodePcxLine(char *dest, BYTE* &src, int bytes)
{
	int	n = 0;
	int	i;
	char c;
...
void CPcx::SetupBitmapInfo(void)
{
...
HRESULT CPcx::CopyToSurface(CSurface *pSurface)
{
	DDSURFACEDESC	ddsd;
