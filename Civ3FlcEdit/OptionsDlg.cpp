...
void
COptionsDlg::OnSelchangeTab(NMHDR* pNMHDR, LRESULT* pResult)
{
    ActivateTab();
    *pResult = 0;
}
...
void
COptionsDlg::OnSize(UINT nType, int cx, int cy)
{
