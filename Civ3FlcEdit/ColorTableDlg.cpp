...
void CColorTableDlg::DoDataExchange(CDataExchange* pDX)
{
...
BOOL CColorTableDlg::OnInitDialog() 
{
	ASSERT(m_pPal);
	if (!m_pPal)
	{
...
// 
LONG CColorTableDlg::OnSelEndOK(UINT lParam, LONG /*wParam*/)
{
...
// 
LONG CColorTableDlg::OnSelEndCancel(UINT lParam, LONG /*wParam*/)
{
	OnCancel();
    return TRUE;
}
...
// 
LONG CColorTableDlg::OnSelChange(UINT lParam, LONG /*wParam*/)
{
...
void CColorTableDlg::UpdateColorInfo()
{
	// Current color
...
void CColorTableDlg::OnSelectColor() 
{
...
void CColorTableDlg::OnCancel() 
{
	// Nothing changed...
	CDialogX::OnCancel();
}

void CColorTableDlg::OnChangeColorRedS() 
{
...
void CColorTableDlg::OnChangeColorGreenS() 
{
	CDataExchange dx(this, TRUE);
...
void CColorTableDlg::OnChangeColorBlueS() 
{
	CDataExchange dx(this, TRUE);
...
//
HBRUSH CColorTableDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CColorTableDlg::ChangeSelectedRGB()
{
...
BOOL CColorTableDlg::PreTranslateMessage(MSG* pMsg) 
{
...
void CColorTableDlg::OnTimer(UINT nIDEvent) 
{
