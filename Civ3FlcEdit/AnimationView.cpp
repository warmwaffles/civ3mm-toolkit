...
#ifdef _DEBUG
void
CAnimationView::AssertValid() const
{
    CView::AssertValid();
}

void
CAnimationView::Dump(CDumpContext& dc) const
{
    CView::Dump(dc);
}
#endif //_DEBUG
...
// CAnimationView message handlers
void
CAnimationView::UpdateControlsState()
{
    m_bPlayStatic = FALSE;
...
void
CAnimationView::OnUpdateFlcPlay(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(m_pPanelAnimation->m_btnPlay.IsWindowEnabled());
}

void
CAnimationView::OnUpdateFlcPause(CCmdUI* pCmdUI)
{
...
void
CAnimationView::OnUpdateFlcStop(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(m_pPanelAnimation->m_btnStop.IsWindowEnabled());
}

void
CAnimationView::OnUpdateFlcInfo(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(m_pPanelExtra->m_btnInfo.IsWindowEnabled());
}

void
CAnimationView::OnDirectionSW()
{
    SetDirection(DirSW);
}

void
CAnimationView::OnDirectionW()
{
    SetDirection(DirW);
}

void
CAnimationView::OnDirectionNW()
{
    SetDirection(DirNW);
}

void
CAnimationView::OnDirectionN()
{
    SetDirection(DirN);
}

void
CAnimationView::OnDirectionNE()
{
    SetDirection(DirNE);
}

void
CAnimationView::OnDirectionE()
{
    SetDirection(DirE);
}

void
CAnimationView::OnDirectionSE()
{
    SetDirection(DirSE);
}

void
CAnimationView::OnDirectionS()
{
    SetDirection(DirS);
}

void
CAnimationView::OnDirectionAll()
{
    SetDirection(DirAll);
}

void
CAnimationView::OnBgdDefault()
{
    ResetBackgroundColor();
}

void
CAnimationView::OnUpdateBgdDefault(CCmdUI* pCmdUI)
{
...
LONG
CAnimationView::OnSelEndOK(UINT lParam, LONG wParam)
{
...
void
CAnimationView::OnUpdateBgdSelect(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && (!IsLeaderHead() && IsUseAlphaBlending()));
}

void
CAnimationView::OnBgdSea()
{
    if (!SetBgdImg(BgdSea))
...
void
CAnimationView::OnUpdateBgdSea(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && (!IsLeaderHead() && IsUseAlphaBlending()));
...
void
CAnimationView::OnUpdateBgdLand(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && (!IsLeaderHead() && IsUseAlphaBlending()));
...
void
CAnimationView::OnCustomColor()
{
    SetBackgroundColor(m_bgdCustomColor);
}

void
CAnimationView::OnUpdateFlcCustomColor(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && (!IsLeaderHead() && IsUseAlphaBlending()));
...
void
CAnimationView::OnUpdateFlcFirst(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(m_pPanelAnimation->m_btnFirst.IsWindowEnabled());
}

void
CAnimationView::OnPrevious()
{
    StopRewind();
...
void
CAnimationView::OnUpdateFlcPrevious(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(m_pPanelAnimation->m_btnPrevious.IsWindowEnabled());
}

void
CAnimationView::OnNext()
{
    StopRewind();
    SetFramePos(FrmNext);
}
...
void
CAnimationView::OnUpdateFlcNext(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(m_pPanelAnimation->m_btnNext.IsWindowEnabled());
}

void
CAnimationView::OnLast()
{
    StopRewind();
    SetFramePos(FrmLast);
}
...
void
CAnimationView::OnUpdateFlcLast(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(m_pPanelAnimation->m_btnLast.IsWindowEnabled());
}

void
CAnimationView::UpdateInfo()
{
    if (!m_bActive)
        return;
...
void
CAnimationView::ReleasedcaptureFramesSlider(WORD pos)
{
...
void
CAnimationView::UpdateFrameSlider()
{
    if (!m_bActive)
        return;
...
LRESULT
CAnimationView::WindowProc(UINT message, WPARAM wParam, LPARAM lParam)
{
    switch (message) {
...
void
CAnimationView::OnRadioTimerDef()
{
    //	UpdateData();
    UseDefaultTimer();
    UpdateControlsState();
...
void
CAnimationView::OnRadioTimerCustom()
{
    //	UpdateData();
...
void
CAnimationView::SelendokComboPalettes(int nOldPalette)
{
    if (!ChangePalette(m_pPanelView->m_nPalette)) {
        ...
        m_pPanelView->m_wndPalettes.SetItemColor(
          m_pPanelView->m_nPalette, RGB(m_rgbPal.pal[CIV_COLOR].rgbRed, m_rgbPal.pal[CIV_COLOR].rgbGreen, m_rgbPal.pal[CIV_COLOR].rgbBlue));
    }
...
void
CAnimationView::OnUpdateFlcBack(CCmdUI* pCmdUI)
{
...
void
CAnimationView::OnUpdateFlcForward(CCmdUI* pCmdUI)
{
...
void
CAnimationView::OnImportPalette()
{
    if (!IsLoaded())
        return;

    if (!ImportPalette(m_rgbPal) || !ApplyPaletteChanges()) {
        OnInitialUpdate();
        return;
    }
...
void
CAnimationView::OnExportPalette()
{
    if (!IsLoaded())
        return;
...
void
CAnimationView::OnRefresh()
{
    Refresh();
}

void
CAnimationView::OnUseAlphaBlending()
{
...
void
CAnimationView::OnUpdateUseAlphaBlending(CCmdUI* pCmdUI)
{
...
void
CAnimationView::OnCopyToClipboard()
{
    CFlcImage img;
    img.CopyToClipboard();
}
...
CAnimationView::Init()
{
    ...
    SetWindowPos(NULL, 0, 0, WND_CX, WND_CY, SWP_NOMOVE | SWP_NOZORDER | SWP_NOACTIVATE);
    ...
    UpdateFrameSlider();
    m_pPanelView->m_wndPalettes.SetItemColor(
      0, RGB(m_rgbPal.pal[CIV_COLOR].rgbRed, m_rgbPal.pal[CIV_COLOR].rgbGreen, m_rgbPal.pal[CIV_COLOR].rgbBlue));
    m_pPanelView->UpdateData(FALSE);
    /*	
...
//
BOOL
CAnimationView::LoadAnimation(LPCTSTR lpszPathName, BOOL bColorTable /*=TRUE*/)
{
    ClearSFrames();
...
void
CAnimationView::SetBackgroundColor(COLORREF color)
{
...
void
CAnimationView::ResetBackgroundColor()
{
    SAFE_DELETE(m_bgdSurface);
    m_bgdColor =
      RGB(GetBValue(m_bgdDefaultColor), GetGValue(m_bgdDefaultColor), GetRValue(m_bgdDefaultColor)); //::GetSysColor(COLOR_BTNFACE);
    m_eBackground = BgdDefault;
    m_bPlayStatic = FALSE;
...
BOOL
CAnimationView::SetBackgroundImage(LPCTSTR lpszImgPath)
{
    SAFE_DELETE(m_bgdSurface);
...
void
CAnimationView::UpdateFrame(float t)
{
    if (m_bDefaultTimer) {
        m_speed -= t;
...
void
CAnimationView::DrawFrame()
{
    if (!m_bPlayStatic && m_curFrame == m_prevFrame) {
        if (m_bPlaying) {
            if (m_bPaused)
                m_bPlayStatic = TRUE;
        } else
    ...
    if (m_bLeaderHead || !m_bUseAlphaBlending) {
        m_pScreen->GetBack()->GetDDS()->BltFast(
          m_xPos, m_yPos, m_arSFrames[m_curFrame]->GetDDS(), NULL, DDBLTFAST_SRCCOLORKEY | DDBLTFAST_WAIT);
        return;
    }
    ...
    for (yFind = 0; yFind < m_nFrmHeight; yFind++) {
        ...
        for (xFind = 0; xFind < m_nFrmWidth; xFind++) {
            // shadow
            if (m_alphaShadow[pos].rgbBlue > 0 || m_alphaShadow[pos].rgbGreen > 0 || m_alphaShadow[pos].rgbRed > 0) {
            ...
            // smoke
            if (m_alphaSmoke[pos].rgbBlue > 0 || m_alphaSmoke[pos].rgbGreen > 0 || m_alphaSmoke[pos].rgbRed > 0) {
                /*
				// a new variant
...
BOOL
CAnimationView::LoadAnimationFile(LPCTSTR lpszPathName)
{
    if (lpszPathName[0] == NULL)
        return FALSE;
...
void
CAnimationView::SetFramePos(EFramePos pos)
{
    if (!IsLoaded())
        return;
...
EDirection
CAnimationView::SetDirection(EDirection direction)
{
    if (!IsLoaded())
        return m_eDirection;
...
void
CAnimationView::OnTimer(UINT nIDEvent)
{
    switch (nIDEvent) {
        ...
        case TIMER_REWIND_ID: {
            ...
            if ((m_curFrame <= m_firstFrame) || (m_curFrame >= m_lastFrame))
                StopRewind();
            break;
        }
    }
...
void
CAnimationView::StartAnimationTimer()
{
    KillAnimationTimer();
...
void
CAnimationView::KillAnimationTimer()
{
...
BOOL
CAnimationView::SetBgdImg(EBdg typeBgd)
{
    UINT nId;
...
void
CAnimationView::UpdateBackground()
{
...
void
CAnimationView::UseDefaultTimer(BOOL bUseDefault)
{
...
void
CAnimationView::SetTimerValue(UINT uElapse)
{
    m_uElapse = uElapse;
    StartAnimationTimer();
}
...
BOOL
CAnimationView::IsDefaultTimer()
{
    return m_bDefaultTimer;
}

BOOL
CAnimationView::SetCivColorPalette(LPCTSTR lpszImgPath /*=NULL*/)
{
    BYTE nColor = 0;
    if (lpszImgPath != NULL) {
        if (!uIsFileExist(lpszImgPath))
...
BOOL
CAnimationView::IsLeaderHead()
{
    return m_bLeaderHead;
}

BOOL
CAnimationView::ReloadWithPalette()
{
    if (!IsLoaded())
        return FALSE;
...
COLORREF
CAnimationView::GetDefaultBgdColor()
{
    return m_bgdDefaultColor;
}

BOOL
CAnimationView::ApplyPaletteChanges()
{
...
BOOL
CAnimationView::UseAlphaBlending(BOOL bUse)
{
...
BOOL
CAnimationView::ChangePalette(BYTE nColor, RGBQUADPAL* pPal /*=NULL*/)
{
    ASSERT(nColor < 33);
...
BOOL
CAnimationView::GetCivColorPalette(RGBQUADPAL* pPal, LPCTSTR lpszImgPath /*=NULL*/)
{
    if (lpszImgPath != NULL) {
        if (!uIsFileExist(lpszImgPath))
            return FALSE;
...
//
BOOL
CAnimationView::GetWavFromAmb(CString sPath, CStringArray* pArWav, BOOL bSilent /*= TRUE*/)
{
...
void
CAnimationView::SelectWavPath()
{
    CString sFilePath;
    CString sPath;

    CFileWavDlg dlg(TRUE,
                    NULL,
                    NULL,
    ...
    if (sExt.CompareNoCase("amb") == 0) {
        ...
        if (GetWavFromAmb(sPath, &m_arPathWAV, FALSE)) {
            ...
            InfoShowDialog(
              uFormatString(IDS_CHECK_AMB_RESULT, sPath, sWavList), uLoadString(IDS_CHECK_AMB_HEADER), 0, uLoadString(IDS_CHECK_AMB_CAP));
        } else
            return;
    } else
...
void
CAnimationView::ActivateDlgBar(BOOL bActivate)
{
    m_bActive = bActivate;
...
void
CAnimationView::OnUpdateWindowCloseall(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(TRUE);
}

void
CAnimationView::OnSaveFrameToFile()
{
    CFlcImage img;
...
void
CAnimationView::OnUpdateLoaded(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded());
}

void
CAnimationView::OnUpdateDirectionAll(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded());
...
void
CAnimationView::OnUpdateDirectionE(CCmdUI* pCmdUI)
{
...
void
CAnimationView::OnUpdateDirectionN(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && m_nDirCount == DIRECTIONS_MAX);
...
void
CAnimationView::OnUpdateDirectionNE(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && m_nDirCount == DIRECTIONS_MAX);
...
void
CAnimationView::OnUpdateDirectionNW(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && m_nDirCount == DIRECTIONS_MAX);
...
void
CAnimationView::OnUpdateDirectionS(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && m_nDirCount == DIRECTIONS_MAX);
...
void
CAnimationView::OnUpdateDirectionSE(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && m_nDirCount == DIRECTIONS_MAX);
...
void
CAnimationView::OnUpdateDirectionSW(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && m_nDirCount == DIRECTIONS_MAX);
...
void
CAnimationView::OnUpdateDirectionW(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && m_nDirCount == DIRECTIONS_MAX);
...
void
CAnimationView::OnUpdateBgdGrid(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && (!IsLeaderHead() && IsUseAlphaBlending()));
...
void
CAnimationView::OnUpdateBgdImg(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && (!IsLeaderHead() && IsUseAlphaBlending()));
...
void
CAnimationView::OnUpdateSelectImg(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(IsLoaded() && (!IsLeaderHead() && IsUseAlphaBlending()));
}

void
CAnimationView::UpdateParams()
{
    CWinApp* pApp    = AfxGetApp();
    m_bShowStaticFrm = pApp->GetProfileInt(REG_OPTIONS, REG_ANIM_TYPE, 0);
    m_bIgnoreOffset  = pApp->GetProfileInt(REG_OPTIONS, REG_IGNORE_OFFSET, 0);
