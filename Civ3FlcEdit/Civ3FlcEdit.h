...
class CCiv3FlcEditApp : public CWinApp
{
  public:
    ...
    EPalType GetPaletteType()
    {
        return m_palType;
    }
    BOOL IsCivRegistered()
    {
        return m_bCivRegistered;
    }
    CString GetCivInstallPath()
    {
        return m_sCivInstallPath;
    }
    BOOL IsC3CRegistered()
    {
        return m_bC3CRegistered;
    }
    CString GetC3CInstallPath()
    {
        return m_sC3CInstallPath;
    }
    BOOL IsPtwRegistered()
    {
        return m_bPtwRegistered;
    }
    CString GetPtwInstallPath()
    {
        return m_sPtwInstallPath;
    }

    CString GetPaletteDirectory()
    {
        return m_sPalDir;
    }
    CCiv3FlcEditApp();
    ...
    BOOL IsLoadLastDoc()
    {
        return m_bLoadLastDoc;
    }
    BOOL IsStartup()
    {
        return m_bStartup;
    }
    BOOL IsShowStaticFrm()
    {
        return m_bShowStaticFrm;
    }
    BOOL IsExpOpen()
    {
        return m_bExpOpen;
