...
#ifdef _DEBUG
void CFlcDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void CFlcDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
BOOL CFlcDoc::OnOpenDocument(LPCTSTR lpszPathName) 
{
	CWaitCursor wait;
...
BOOL CFlcDoc::OnSaveDocument(LPCTSTR lpszPathName) 
{
	return TRUE;
