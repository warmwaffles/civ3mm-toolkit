...
void
CFlcInfoGen::DoDataExchange(CDataExchange* pDX)
{
...
CFlcInfoGen::OnInitDialog()
{
    ...
    m_Table.InsertColumn(COL_ID, uLoadString(IDS_COL_ID), LVCFMT_LEFT, 150);

    m_Table.InsertColumn(COL_INFO, uLoadString(IDS_COL_INFO), LVCFMT_LEFT, 100);
