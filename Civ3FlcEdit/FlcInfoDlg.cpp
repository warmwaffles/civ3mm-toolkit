...
void
CFlcInfoDlg::DoDataExchange(CDataExchange* pDX)
{
...
void
CFlcInfoDlg::OnSelchangeTab(NMHDR* pNMHDR, LRESULT* pResult)
{
    ActivateTab();
    *pResult = 0;
}
...
void
CFlcInfoDlg::OnSize(UINT nType, int cx, int cy)
{
...
CFlcInfoDlg::OnSave()
{
    CFileDialogX dlg(FALSE, NULL, "Info.txt", OFN_OVERWRITEPROMPT | OFN_HIDEREADONLY, CString((LPCTSTR)IDS_FILTER_TXT));
