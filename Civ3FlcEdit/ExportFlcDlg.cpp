...
void CExportFlcDlg::DoDataExchange(CDataExchange* pDX)
{
...
BOOL CExportFlcDlg::OnInitDialog() 
{
...
void CExportFlcDlg::OnSelchangeTab(NMHDR* pNMHDR, LRESULT* pResult) 
{
	ActivateTab();
...
void CExportFlcDlg::ActivateTab()
{
	CWnd* pWnd = GetTab();
...
void CExportFlcDlg::AdjustSheetSizes()
{
...
void CExportFlcDlg::OnSize(UINT nType, int cx, int cy) 
{
	CDialogX::OnSize(nType, cx, cy);
	AdjustSheetSizes();
}

void CExportFlcDlg::UpdateControlsState()
{
	UpdateData();
}

void CExportFlcDlg::OnOK() 
{
	ApplyChanges();
...
void CExportFlcDlg::ApplyChanges()
{
	BOOL bChanged = FALSE;
...
void CExportFlcDlg::OnPreviewCheck() 
{
	UpdateData();
...
void CExportFlcDlg::PreviewDlgInit()
{
...
void CExportFlcDlg::PreviewDlgStart()
{
...
void CExportFlcDlg::PreviewDlgStop()
{
...
void CExportFlcDlg::OnSaveSettings() 
{
	UpdateData();
}
