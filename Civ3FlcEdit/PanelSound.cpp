...
void CPanelSound::DoDataExchange(CDataExchange* pDX)
{
...
void CPanelSound::SetView(CAnimationView *pView)
{
	m_pView = pView;
...
BOOL CPanelSound::IsAttached()
{
	return (m_pView != NULL && m_pView->GetSafeHwnd());
}

void CPanelSound::OnDestroy() 
{
	CWinApp* pApp = AfxGetApp();
...
void CPanelSound::UpdateControlsState()
{
...
BOOL CPanelSound::PreTranslateMessage(MSG* pMsg) 
{
