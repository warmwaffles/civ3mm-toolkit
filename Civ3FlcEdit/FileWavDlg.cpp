...
CFileWavDlg::CFileWavDlg(BOOL bOpenFileDialog, LPCTSTR lpszDefExt, LPCTSTR lpszFileName,
...
void CFileWavDlg::DoDataExchange(CDataExchange* pDX)
{
...
void CFileWavDlg::OnFileNameChange()
{
...
void CFileWavDlg::OnFolderChange()
{
...
void CFileWavDlg::OnSize(UINT nType, int cx, int cy) 
{
...
void CFileWavDlg::PlaySoundFile()
{
...
void CFileWavDlg::StopSoundFile()
{
	sndPlaySound(NULL, SND_SYNC);
}

void CFileWavDlg::OnStop() 
{
	StopSoundFile();
}

void CFileWavDlg::OnPlay() 
{
	PlaySoundFile();
}

void CFileWavDlg::OnDestroy() 
{
	CWinApp* pApp = AfxGetApp();
