...
CDocTemplateC3f::CDocTemplateC3f(UINT nIDResource, CRuntimeClass* pDocClass, CRuntimeClass* pFrameClass, CRuntimeClass* pViewClass, CDocManagerEx* pDocManager) :
...
CDocument* CDocTemplateC3f::OpenDocumentFile(LPCTSTR lpszPathName, BOOL bMakeVisible)
{
	CString sLastPath;
...
CC3fDoc* CDocTemplateC3f::GetC3fDoc()
{
	POSITION pos = GetFirstDocPosition();
	return (pos == NULL) ? NULL : (CC3fDoc*)GetNextDoc(pos);
}

CDocManagerEx* CDocTemplateC3f::GetDocManager()
{
	return m_pDocManager;
}

CDocTemplate::Confidence CDocTemplateC3f::MatchDocType(LPCTSTR lpszPathName, CDocument *&rpDocMatch)
{
...
void CDocTemplateC3f::InitialUpdateFrame(CFrameWnd *pFrame, CDocument *pDoc, BOOL bMakeVisible)
{
