...
CFileImgDlg::CFileImgDlg(BOOL bOpenFileDialog,
                         LPCTSTR lpszDefExt,
...
void
CFileImgDlg::DoDataExchange(CDataExchange* pDX)
{
...
void
CFileImgDlg::OnSize(UINT nType, int cx, int cy)
{
...
//
CString
CFileImgDlg::GetColorModeName(int nBitsPerPixel)
{
    CString sColorMode;
    switch (m_nBitsPerPixel) {
        case cm_256Colors:
            sColorMode = uLoadString(IDS_COLOR_256);
            break;
        case cm_TrueColor:
            sColorMode = uLoadString(IDS_COLOR_TRUE);
            break;
        default:
            sColorMode = uLoadString(IDS_COLOR_256);
    }
...
void
CFileImgDlg::OnDeltaposHeightSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void
CFileImgDlg::OnDeltaposWidthSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeWidth();
    *pResult = 0;
