...
void
CNewFlcFrm::DoDataExchange(CDataExchange* pDX)
{
...
void
CNewFlcFrm::UpdateControlsState()
{
    UpdateData();
...
void
CNewFlcFrm::OnDeltaposFrmCountSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void
CNewFlcFrm::OnDeltaposFrmHeightSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeFrmHeight();
    *pResult = 0;
...
void
CNewFlcFrm::OnDeltaposFrmWidthSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeFrmWidth();
    *pResult = 0;
...
void
CNewFlcFrm::OnReleasedcaptureTimerSlider(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void
CNewFlcFrm::OnChangeDirCount()
{
    m_bChanged = TRUE;
}

void
CNewFlcFrm::OnDirCount()
{
    UpdateControlsState();
    m_bChanged = TRUE;
}
...
void
CNewFlcFrm::OnDeltaposFrmTopSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeFrmTop();
    *pResult = 0;
...
void
CNewFlcFrm::OnDeltaposFrmLeftSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeFrmLeft();
    *pResult = 0;
...
void
CNewFlcFrm::OnDeltaposSpinDelay(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeDelay();
