...
void CSelectBgdImgDlg::DoDataExchange(CDataExchange* pDX)
{
...
BOOL CSelectBgdImgDlg::OnInitDialog() 
{
...
void CSelectBgdImgDlg::OnDestroy() 
{
	SavePosition(this);
	CDialogX::OnDestroy();
}

BOOL CSelectBgdImgDlg::PreTranslateMessage(MSG* pMsg) 
{
...
void CSelectBgdImgDlg::OnSize(UINT nType, int cx, int cy) 
{
...
void CSelectBgdImgDlg::OnBrowse() 
{
	try
	{
...
void CSelectBgdImgDlg::OnDelete() 
{
	CloseFile();
	m_sTargetPath.Empty();
	UpdateData(FALSE);
...
void CSelectBgdImgDlg::UpdateControlsState()
{
	UpdateData();
	UpdatePreview();
}

void CSelectBgdImgDlg::UpdatePreview()
{
	CRect rc;
...
BOOL CSelectBgdImgDlg::LoadBgdImgFile(LPCTSTR sPath)
{
	try
	{
		LoadFile(sPath);
