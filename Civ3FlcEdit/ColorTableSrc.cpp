...
void CColorTableSrc::OnRButtonUp(UINT nFlags, CPoint point) 
{
}

void CColorTableSrc::OnPaint() 
{
...
void CColorTableSrc::OnNcDestroy() 
{
    CColorTable::OnNcDestroy();
}

void CColorTableSrc::OnMouseMove(UINT nFlags, CPoint point) 
{
	CColorTable::OnMouseMove(nFlags, point);
}

void CColorTableSrc::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	CColorTable::OnKeyDown(nChar, nRepCnt, nFlags);
}

BOOL CColorTableSrc::OnQueryNewPalette() 
{
    return CColorTable::OnQueryNewPalette();
}

void CColorTableSrc::OnPaletteChanged(CWnd* pFocusWnd) 
{
    CColorTable::OnPaletteChanged(pFocusWnd);
}

void CColorTableSrc::OnActivateApp(BOOL bActive, HTASK hTask) 
{
	CColorTable::OnActivateApp(bActive, hTask);
}

void CColorTableSrc::OnLButtonUp(UINT nFlags, CPoint point)
{
