...
void CNewFlcPal::DoDataExchange(CDataExchange* pDX)
{
...
void CNewFlcPal::UpdateControlsState()
{
	UpdateData();
...
void CNewFlcPal::OnBrowseLastColorsPath()
{
...
void CNewFlcPal::OnLastColors() 
{
	m_bChanged = TRUE;
	UpdateControlsState();
}

void CNewFlcPal::OnBitsPerPixel() 
{
	m_bChanged = TRUE;
...
void CNewFlcPal::OnMakePalette() 
{
	m_bChanged = TRUE;
}

void CNewFlcPal::OnSelendokPalType() 
{
	m_bChanged = TRUE;
}


void CNewFlcPal::OnSelectivePal() 
{
	m_bChanged = TRUE;
	UpdateControlsState();
}

void CNewFlcPal::OnBrowsePalPath() 
{
	CFileDialogX dlg(TRUE, NULL, NULL,
		OFN_FILEMUSTEXIST | OFN_PATHMUSTEXIST,
		_T(uLoadString(IDS_FILTER_PAL_IMP)));
...
void CNewFlcPal::OnPalette() 
{
	UpdateControlsState();
	m_bChanged = TRUE;
}

HBRUSH CNewFlcPal::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CNewFlcPal::OnSelendokComboPalettes() 
{
	m_bChanged = TRUE;
//	UpdateData();
//
