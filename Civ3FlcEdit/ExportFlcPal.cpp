...
void
CExportFlcPal::DoDataExchange(CDataExchange* pDX)
{
...
void
CExportFlcPal::UpdateControlsState()
{
    UpdateData();
...
void
CExportFlcPal::OnBrowseLastColorsPath()
{
...
void
CExportFlcPal::OnMakePalette()
{
    m_bChanged = TRUE;
}

void
CExportFlcPal::OnSelendokPalType()
{
    m_bChanged = TRUE;
}

void
CExportFlcPal::OnPalette()
{
    UpdateControlsState();
    m_bChanged = TRUE;
}
...
HBRUSH
CExportFlcPal::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void
CExportFlcPal::OnSelendokComboPalettes()
{
    m_bChanged = TRUE;
    //	UpdateData();
    //
