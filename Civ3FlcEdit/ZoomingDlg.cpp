...
void CZoomingDlg::DoDataExchange(CDataExchange* pDX)
{
...
void CZoomingDlg::OnZoomIn() 
{
	m_wndZooming.ZoomIn();
	UpdatePreview();
}

void CZoomingDlg::OnZoomOut() 
{
	m_wndZooming.ZoomOut();
	UpdatePreview();
}

void CZoomingDlg::OnSelendokZooming() 
{
	CString str;
...
void CZoomingDlg::OnKillfocusZooming() 
{
	if (GetSafeHwnd())
	{
		CString str;
...
BOOL CZoomingDlg::GetImage()
{
	...
	try
	{
		...
		GRAPHX::CreateBitmap(&m_hbmp, TYPE_CONV, m_nWidth, m_nHeight, 
...
void CZoomingDlg::OnSize(UINT nType, int cx, int cy) 
{
	UpdatePreview();
	CDialogX::OnSize(nType, cx, cy);
}

void CZoomingDlg::OnSave() 
{
...
void CZoomingDlg::UpdatePreview()
{
	if (m_wndPreview.GetSafeHwnd())
	{
		CRect rc;
...
BOOL CZoomingDlg::PreTranslateMessage(MSG* pMsg) 
{
...
void CZoomingDlg::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
...
void CZoomingDlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	// Get the minimum and maximum scroll-bar positions.
	int minpos;
	int maxpos;
...
void CZoomingDlg::OnZoomFit() 
{
	UpdateControlsState();
}

void CZoomingDlg::UpdateControlsState()
{
	UpdateData();
