...
void
CExportFlcOut::DoDataExchange(CDataExchange* pDX)
{
...
void
CExportFlcOut::UpdateControlsState()
{
    UpdateData();
...
void
CExportFlcOut::OnSelendokFileType()
{
    m_bChanged = TRUE;
}

void
CExportFlcOut::OnChangeFileName()
{
    m_bChanged = TRUE;
}

void
CExportFlcOut::OnDestroy()
{
