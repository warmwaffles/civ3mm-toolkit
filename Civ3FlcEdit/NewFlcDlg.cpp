...
void
CNewFlcDlg::DoDataExchange(CDataExchange* pDX)
{
...
void
CNewFlcDlg::OnSelchangeTab(NMHDR* pNMHDR, LRESULT* pResult)
{
    ActivateTab();
...
void
CNewFlcDlg::OnSize(UINT nType, int cx, int cy)
{
...
void
CNewFlcDlg::UpdateControlsState()
{
    UpdateData();
}
