...
// 
LONG CColorReplaceDlg::OnSelEndOK(UINT lParam, LONG wParam)
{
...
// 
LONG CColorReplaceDlg::OnSelEndCancel(UINT lParam, LONG wParam)
{
	OnCancel();
    return TRUE;
}
...
// 
LONG CColorReplaceDlg::OnSelChange(UINT lParam, LONG wParam)
{
	COLORREF col = (COLORREF)lParam;
	if (wParam == IDC_COLOR_TABLE)
	{
...
void CColorReplaceDlg::UpdateColorInfo(UINT nID)
{
...
void CColorReplaceDlg::OnDestroy() 
{
...
void CColorReplaceDlg::OnSelectColor() 
{
...
void CColorReplaceDlg::OnChangeColorRedS() 
{
...
void CColorReplaceDlg::OnChangeColorGreenS() 
{
	CDataExchange dx(this, TRUE);
...
void CColorReplaceDlg::OnChangeColorBlueS() 
{
	CDataExchange dx(this, TRUE);
...
//
HBRUSH CColorReplaceDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CColorReplaceDlg::ChangeSelectedRGB()
{
...
BOOL CColorReplaceDlg::PreTranslateMessage(MSG* pMsg) 
{
...
void CColorReplaceDlg::OnTimer(UINT nIDEvent) 
{
...
void CColorReplaceDlg::UpdateControlsState()
{
	UpdateData();
...
void CColorReplaceDlg::OnBrowseDestPath() 
{
	CFileDialogX dlg(TRUE, NULL, CFileX::GetShortFileName(m_sPathD),
		OFN_PATHMUSTEXIST | OFN_FILEMUSTEXIST,
		_T(uLoadString(IDS_FILTER_GET_PALETTE)),
		this);
...
void CColorReplaceDlg::OnBrowseSrcPath() 
{
	CFileDialogX dlg(TRUE, NULL, CFileX::GetShortFileName(m_sPathS),
		OFN_PATHMUSTEXIST | OFN_FILEMUSTEXIST,
		_T(uLoadString(IDS_FILTER_GET_PALETTE)),
		this);
...
void CColorReplaceDlg::OnReplaceColor() 
{
...
void CColorReplaceDlg::OnSave() 
{
	ExportPalette(m_rgbPalD);
}

BOOL CColorReplaceDlg::GetPalette(CString sPath, RGBQUADPAL &palette)
{
	CWaitCursor wait;
	...
	else if (sExt.CompareNoCase(PCX_EXT) == 0 ||
		sExt.CompareNoCase(BMP_EXT) == 0)
	{
		CFlcImage img;
		try
		{
			...
			GRAPHX::ColorResBitmap(&img.m_hbmp, &img.m_hbmp, 8,
...
void CColorReplaceDlg::OnReplaceRange() 
{
...
void CColorReplaceDlg::OnSelendokComboPalettes() 
{
...
void CColorReplaceDlg::OnMoveColors() 
{
...
void CColorReplaceDlg::OnSelPalette() 
{
	UpdateControlsState();
...
void CColorReplaceDlg::OnCivPalette() 
{
	UpdateControlsState();
...
BOOL CColorReplaceDlg::ChangePalette(BYTE nColor)
{
	ASSERT(nColor < 33);
...
BOOL CColorReplaceDlg::GetCivColorPalette(RGBQUADPAL *pPal, LPCTSTR lpszImgPath /*=NULL*/)
{
	if (lpszImgPath != NULL)
	{
...
BOOL CColorReplaceDlg::SetCivColorPalette(LPCTSTR lpszImgPath /*=NULL*/)
{
	BYTE nColor = 0;
	if (lpszImgPath != NULL)
	{
...
void CColorReplaceDlg::ClearPalette(RGBQUADPAL &palette)
{
	RGBQUAD colorDef;
	colorDef.rgbRed			= 255;
	colorDef.rgbGreen		= 0;
...
void CColorReplaceDlg::SetPaletteD()
{
...
void CColorReplaceDlg::SetPaletteS()
{
...
void CColorReplaceDlg::ApplyColorChanges()
{
...
void CColorReplaceDlg::OnRefresh()
{
...
void CColorReplaceDlg::OnSelectImg() 
{
