...
void
CPanelDirection::DoDataExchange(CDataExchange* pDX)
{
...
void
CPanelDirection::SetView(CAnimationView* pView)
{
    m_pView = pView;
...
void
CPanelDirection::OnDirectionAll()
{
    if (IsAttached())
...
BOOL
CPanelDirection::IsAttached()
{
    return (m_pView != NULL && m_pView->GetSafeHwnd());
}

void
CPanelDirection::UpdateControlsState()
{
    if (m_pView->IsLoaded()) {
...
BOOL
CPanelDirection::PreTranslateMessage(MSG* pMsg)
{
