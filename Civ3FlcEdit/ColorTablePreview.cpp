...
void
CColorTablePreview::OnRButtonUp(UINT nFlags, CPoint point)
{
}

void
CColorTablePreview::OnPaint()
{
    CColorTable::OnPaint();
}

void
CColorTablePreview::OnNcDestroy()
{
    CColorTable::OnNcDestroy();
}

void
CColorTablePreview::OnMouseMove(UINT nFlags, CPoint point)
{
    CColorTable::OnMouseMove(nFlags, point);
}

void
CColorTablePreview::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
    CColorTable::OnKeyDown(nChar, nRepCnt, nFlags);
}

BOOL
CColorTablePreview::OnQueryNewPalette()
{
    return CColorTable::OnQueryNewPalette();
}

void
CColorTablePreview::OnPaletteChanged(CWnd* pFocusWnd)
{
    CColorTable::OnPaletteChanged(pFocusWnd);
}

void
CColorTablePreview::OnActivateApp(BOOL bActive, HTASK hTask)
{
    CColorTable::OnActivateApp(bActive, hTask);
}

void
CColorTablePreview::OnLButtonUp(UINT nFlags, CPoint point)
{
    CColorTable::OnLButtonUp(nFlags, point);
}

void
CColorTablePreview::SetupVariables(UINT& nFrom, UINT& nTo, UINT& nNumber, BOOL& bAllPalette, EPreviewType type)
{
    m_pFrom       = &nFrom;
    m_pTo         = &nTo;
    m_pNumber     = &nNumber;
...
void
CColorTablePreview::DrawCell(CDC* pDC, int nIndex)
{
