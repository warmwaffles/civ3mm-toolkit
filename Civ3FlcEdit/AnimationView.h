...
// Attributes
public:
	CDlgBar* GetDlgBar() { return m_pDlgBar; }
...
public:
	...
	BOOL IsUseAlphaBlending() { return m_bUseAlphaBlending; }
	...
	void SetActive(BOOL bActive) { m_bActive = bActive; m_bPaused = FALSE; }
...
public:
	...
	void SetPathWAV(LPCSTR sPath) { m_sPathWAV = sPath; }
