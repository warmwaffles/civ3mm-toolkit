...
CDocTemplateFlc::CDocTemplateFlc(UINT nIDResource,
...
CDocument*
CDocTemplateFlc::OpenDocumentFile(LPCTSTR lpszPathName, BOOL bMakeVisible)
{
    CString sLastPath;
...
CDocManagerEx*
CDocTemplateFlc::GetDocManager()
{
    return m_pDocManager;
}

CDocTemplate::Confidence
CDocTemplateFlc::MatchDocType(LPCTSTR lpszPathName, CDocument*& rpDocMatch)
{
...
void
CDocTemplateFlc::InitialUpdateFrame(CFrameWnd* pFrame, CDocument* pDoc, BOOL bMakeVisible)
{
