...
void CReplaceRangeDlg::DoDataExchange(CDataExchange* pDX)
{
...
BOOL CReplaceRangeDlg::OnInitDialog() 
{
...
void CReplaceRangeDlg::OnDestroy() 
{
	SavePosition(this);
	CDialog::OnDestroy();
}

void CReplaceRangeDlg::OnOK() 
{
	OnApply();
...
void CReplaceRangeDlg::OnCancel() 
{
	CDialog::OnCancel();
}

void CReplaceRangeDlg::OnChangeRange() 
{
	UpdateData();
...
void CReplaceRangeDlg::OnChangeFirstSrc() 
{
	UpdateData();
	if (m_nTo > IDX_MAX)
	{
...
void CReplaceRangeDlg::OnChangeFirstDest() 
{
	UpdateData();
	if (m_nFrom > IDX_MAX)
	{
...
void CReplaceRangeDlg::UpdateControlsState()
{
	UpdateData();
}

void CReplaceRangeDlg::ChangeVariables()
{
	UpdateData();
...
BOOL CReplaceRangeDlg::PreTranslateMessage(MSG* pMsg) 
{
...
// 
LONG CReplaceRangeDlg::OnSelEndOK(UINT lParam, LONG wParam)
{
