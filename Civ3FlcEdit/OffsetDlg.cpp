...
void COffsetDlg::OnChangeFrmTop() 
{
...
void COffsetDlg::OnDeltaposFrmTopSpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void COffsetDlg::OnChangeFrmLeft() 
{
...
void COffsetDlg::OnDeltaposFrmLeftSpin(NMHDR* pNMHDR, LRESULT* pResult) 
{
	NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
	OnChangeFrmLeft();
	*pResult = 0;
...
void COffsetDlg::UpdateControlsState()
{
	UpdateData();
