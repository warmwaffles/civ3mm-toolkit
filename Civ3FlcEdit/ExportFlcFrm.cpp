...
void
CExportFlcFrm::DoDataExchange(CDataExchange* pDX)
{
...
void
CExportFlcFrm::UpdateControlsState()
{
    UpdateData();
...
void
CExportFlcFrm::OnDeltaposFrmCountSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void
CExportFlcFrm::OnChangeFrmCount()
{
    m_bChanged = TRUE;
...
void
CExportFlcFrm::OnChangeFrmHeight()
{
...
void
CExportFlcFrm::OnDeltaposFrmHeightSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeFrmHeight();
    *pResult = 0;
...
void
CExportFlcFrm::OnChangeFrmWidth()
{
...
void
CExportFlcFrm::OnDeltaposFrmWidthSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeFrmWidth();
    *pResult = 0;
...
void
CExportFlcFrm::OnReleasedcaptureTimerSlider(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void
CExportFlcFrm::OnDeltaposFrmTopSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeFrmTop();
    *pResult = 0;
...
void
CExportFlcFrm::OnDeltaposFrmLeftSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeFrmLeft();
    *pResult = 0;
...
void
CExportFlcFrm::OnDeltaposSpinDelay(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeDelay();
...
void
CExportFlcFrm::OnChangeResizeTop()
{
...
void
CExportFlcFrm::OnDeltaposResizeTopSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeResizeTop();
    *pResult = 0;
...
void
CExportFlcFrm::OnChangeResizeBottom()
{
...
void
CExportFlcFrm::OnDeltaposResizeBottomSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
...
void
CExportFlcFrm::OnChangeResizeLeft()
{
...
void
CExportFlcFrm::OnDeltaposResizeLeftSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeResizeLeft();
    *pResult = 0;
...
void
CExportFlcFrm::OnChangeResizeRight()
{
...
void
CExportFlcFrm::OnDeltaposResizeRightSpin(NMHDR* pNMHDR, LRESULT* pResult)
{
    NM_UPDOWN* pNMUpDown = (NM_UPDOWN*)pNMHDR;
    OnChangeResizeRight();
    *pResult = 0;
