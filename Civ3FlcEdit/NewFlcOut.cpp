...
void
CNewFlcOut::DoDataExchange(CDataExchange* pDX)
{
...
void
CNewFlcOut::UpdateControlsState()
{
    UpdateData();
...
void
CNewFlcOut::OnSelendokFileType()
{
    m_bChanged = TRUE;
}

void
CNewFlcOut::OnChangeFileName()
{
    m_bChanged = TRUE;
}

void
CNewFlcOut::OnAnimationType()
{
    UpdateData();
    m_bChanged = TRUE;
